...
Public Class frmTraspSalida
    ...
    Private Sub btnguardar_Click(sender As System.Object, e As System.EventArgs) Handles btnguardar.Click
        ...
        Try
            ...
            cmd1 = cnn1.CreateCommand
            cmd1.CommandText =
                "insert into Traslados(Nombre,Totales,FVenta,HVenta,Usuario,Folio,Concepto,Cargado,FPago,FCancelado,Comisionista) values('" & cbo.Text & "'," & MyTotal & ",'" & Format(dtpfecha.Value, "yyyy-MM-dd") & "','" & Format(Date.Now, "yyyy-MM-dd HH:mm:ss") & "','" & lblusuario.Text & "'," & lblfolio.Text & ",'SALIDA',0,'" & Format(Date.Now, "yyyy-MM-dd") & "','" & Format(Date.Now, "yyyy-MM-dd") & "','" & cbo.Text & "')"
...
milky:
    ...
    Private Sub cbodocumento_SelectedValueChanged(sender As Object, e As System.EventArgs) Handles cbodocumento.SelectedValueChanged
        ...
        Try
            ...
            cmd1 = cnn1.CreateCommand
            cmd1.CommandText =
                "select * from Traslados where Folio=" & cbodocumento.Text & " and Concepto='SALIDA'"
            rd1 = cmd1.ExecuteReader
            If rd1.HasRows Then
                If rd1.Read Then
            ...
            cmd1 = cnn1.CreateCommand
            cmd1.CommandText =
                "select * from TrasladosDet where Folio=" & id & " and Concepto='SALIDA'"
            rd1 = cmd1.ExecuteReader
            Do While rd1.Read
                If rd1.HasRows Then

Public Class frmTecladoVtaTouchEntrada
    ...
    Private Sub btnAceptar_Click(sender As Object, e As EventArgs) Handles btnAceptar.Click
        ...
        If txtNombre.Text <> "" Then
            ...
            cnn1.Close() : cnn1.Open()
            cmd1 = cnn1.CreateCommand
            cmd1.CommandText = "SELECT * FROM Usuarios WHERE Clave='" & originalText & "'"
            rd1 = cmd1.ExecuteReader
            If rd1.HasRows Then
                If rd1.Read Then
    ...
    Private Sub txtNombre_TextChanged(sender As Object, e As EventArgs) Handles txtNombre.TextChanged
        ...
        originalText = originalText + txtNombre.Text
        ' Reemplaza la cadena con asteriscos en el RichTextBox
        txtNombre.Text = New String("*", originalText.Length)

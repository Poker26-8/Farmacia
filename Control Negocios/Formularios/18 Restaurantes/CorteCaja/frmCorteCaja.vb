...
Public Class frmCorteCaja
    ...
    Private Sub cboUsuario_SelectedValueChanged(sender As Object, e As EventArgs) Handles cboUsuario.SelectedValueChanged
        Try
            ...
            cmd1 = cnn1.CreateCommand
            cmd1.CommandText =
                "select IdEmpleado from Usuarios where Alias='" & cboUsuario.Text & "'"
            rd1 = cmd1.ExecuteReader
            If rd1.HasRows Then
                If rd1.Read Then
                End If
            ...
            If rd1.HasRows Then
                If rd1.Read Then
                    ...
                    If TipoCorte() = 1 Then
                        ...
                        cmd2 = cnn2.CreateCommand
                        cmd2.CommandText =
                            "select Calculo from CorteUsuario where Usuario='" & cboUsuario.Text & "' and NumCorte=" & txtNumCorte.Text & ""
                        rd2 = cmd2.ExecuteReader
                        If rd2.HasRows Then
                            If rd2.Read Then
    ...
    Private Sub btnCalcular_Click(sender As Object, e As EventArgs) Handles btnCalcular.Click
        ...
        Try
            ...
            'Prestamo empleados
            cmd2 = cnn2.CreateCommand
            cmd2.CommandText = "SELECT SUM(Monto) FROM SaldosEmpleados WHERE Usuario='" & Usu & "' AND Fecha BETWEEN '" & Format(dtpFechaIU.Value, "yyyy-MM-dd") & "' AND '" & Format(dtpFechaFU.Value, "yyyy-MM-dd") & "' and CorteU=0"
            rd2 = cmd2.ExecuteReader
            If rd2.HasRows Then
                If rd2.Read Then
            ...
            cmd2.CommandText = "SELECT SUM(Total) FROM otrosgastos WHERE Usuario='" & Usu & "' AND Fecha BETWEEN '" & Format(dtpFechaIU.Value, "yyyy-MM-dd") & "' AND '" & Format(dtpFechaFU.Value, "yyyy-MM-dd") & "' and CorteU=0 AND Concepto='NOMINA'"
            rd2 = cmd2.ExecuteReader
            If rd2.HasRows Then
                If rd2.Read Then
            ...
            cmd2 = cnn2.CreateCommand
            cmd2.CommandText =
                "select SUM(Total) from OtrosGastos where Usuario='" & Usu & "' AND Fecha BETWEEN '" & Format(dtpFechaIU.Value, "yyyy-MM-dd") & "' AND '" & Format(dtpFechaFU.Value, "yyyy-MM-dd") & "' and CorteU=0 AND Concepto<>'NOMINA'"
            rd2 = cmd2.ExecuteReader
            If rd2.HasRows Then
                If rd2.Read Then
            ...
            cmd2 = cnn2.CreateCommand
            cmd2.CommandText =
                    "SELECT SUM(SueldoNeto) FROM Nominas WHERE Usuario='" & Usu & "' AND Fecha BETWEEN '" & Format(dtpFechaIU.Value, "yyyy-MM-dd") & "' AND '" & Format(dtpFechaFU.Value, "yyyy-MM-dd") & "' AND CorteU=0"
            rd2 = cmd2.ExecuteReader
            If rd2.HasRows Then
                If rd2.Read Then
                    Efectivo = CDec(Efectivo) + CDec(IIf(rd2(0).ToString = "", "0", rd2(0).ToString))
            ...
            cmd2 = cnn2.CreateCommand
            cmd2.CommandText =
                    "SELECT SUM(Efectivo) FROM OtrosGastos WHERE Usuario='" & Usu & "' AND Fecha BETWEEN '" & Format(dtpFechaIU.Value, "yyyy-MM-dd") & "' AND '" & Format(dtpFechaFU.Value, "yyyy-MM-dd") & "' AND CorteU=0"
            rd2 = cmd2.ExecuteReader
            If rd2.HasRows Then
                If rd2.Read Then
                    Efectivo = CDec(Efectivo) + CDec(IIf(rd2(0).ToString = "", "0", rd2(0).ToString))
            ...
            cmd2 = cnn2.CreateCommand
            cmd2.CommandText =
                    "select SUM(Tarjeta) from OtrosGastos where Usuario='" & Usu & "' AND Fecha BETWEEN '" & Format(dtpFechaIU.Value, "yyyy-MM-dd") & "' AND '" & Format(dtpFechaFU.Value, "yyyy-MM-dd") & "' and CorteU=0"
            rd2 = cmd2.ExecuteReader
            If rd2.HasRows Then
                If rd2.Read Then
                    Tarjeta = Tarjeta + IIf(rd2(0).ToString = "", "0", rd2(0).ToString)
            ...
            cmd2 = cnn2.CreateCommand
            cmd2.CommandText =
                    "select SUM(Transfe) from OtrosGastos where Usuario='" & Usu & "' AND Fecha BETWEEN '" & Format(dtpFechaIU.Value, "yyyy-MM-dd") & "' AND '" & Format(dtpFechaFU.Value, "yyyy-MM-dd") & "' and CorteU=0"
            rd2 = cmd2.ExecuteReader
            If rd2.HasRows Then
                If rd2.Read Then
                    Transfe = Transfe + IIf(rd2(0).ToString = "", "0", rd2(0).ToString)
    ...
    Private Sub pCalculoGlobal80_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles pCalculoGlobal80.PrintPage
        ...
        Try
            ...
            e.Graphics.DrawString("Desde: " & Format(dtpFecha.Value, "yyyy-MM-dd"), fuente_prods, Brushes.Black, 1, Y)
            e.Graphics.DrawString(Format(dtpHoraIni.Value, "HH:mm:ss"), fuente_prods2, Brushes.Black, 270, Y, sf)
            Y += 23

            e.Graphics.DrawString("Hasta: " & Format(dtpFechaFinal.Value, "yyyy-MM-dd"), fuente_prods, Brushes.Black, 1, Y)
            e.Graphics.DrawString(Format(dtpHoraFin.Value, "HH:mm:ss"), fuente_prods2, Brushes.Black, 270, Y, sf)
            Y += 23
            e.Graphics.DrawString("--------------------------------------------------------", New Drawing.Font(tipografia, 12, FontStyle.Regular), Brushes.Black, 1, Y)
            Y += 20

            e.Graphics.DrawString("SALDO INICIAL", New Drawing.Font(tipografia, 9, FontStyle.Bold), Brushes.Black, 1, Y)
            e.Graphics.DrawString(simbolo & FormatNumber(txtSaldoGlobal.Text, 2), New Drawing.Font(tipografia, 9, FontStyle.Bold), Brushes.Black, 270, Y, sf)
            Y += 28

            e.Graphics.DrawString("TOTAL DE INGRESOS", New Drawing.Font(tipografia, 9, FontStyle.Bold), Brushes.Black, 1, Y)
            e.Graphics.DrawString(simbolo & FormatNumber(txtIngresosGlobal.Text, 2), New Drawing.Font(tipografia, 9, FontStyle.Bold), Brushes.Black, 270, Y, sf)
            Y += 15

            e.Graphics.DrawString(" ING. EFECTIVO", New Drawing.Font(tipografia, 9, FontStyle.Regular), Brushes.Black, 1, Y)
            e.Graphics.DrawString(FormatNumber(txtIngEfectivoG.Text, 2), fuente_prods, Brushes.Black, 270, Y, sf)
            Y += 15
            ...
            For ingresoglobal = 0 To grdingresosglobal.Rows.Count - 1
                ...
                e.Graphics.DrawString(FormatNumber(montopagarglobal, 2), fuente_prods, Brushes.Black, 270, Y, sf)
                Y += 15
            Next
            Y += 20

            e.Graphics.DrawString("TOTAL DE EGRESOS", New Drawing.Font(tipografia, 9, FontStyle.Bold), Brushes.Black, 1, Y)
            e.Graphics.DrawString(simbolo & FormatNumber(txtEgresosGlobal.Text, 2), New Drawing.Font(tipografia, 9, FontStyle.Bold), Brushes.Black, 270, Y, sf)
            Y += 15
            e.Graphics.DrawString(" EGR. EFECTIVO", New Drawing.Font(tipografia, 9, FontStyle.Regular), Brushes.Black, 1, Y)
            e.Graphics.DrawString(FormatNumber(txtEgrEfectivoG.Text, 2), fuente_prods, Brushes.Black, 270, Y, sf)
            Y += 15
            ...
            For regreso = 0 To grdegresosglobal.Rows.Count - 1
                ...
                e.Graphics.DrawString(FormatNumber(montoegresoglobal, 2), fuente_prods, Brushes.Black, 270, Y, sf)
                Y += 15
            ...
            e.Graphics.DrawString(simbolo & FormatNumber(txtSaldoFinalG.Text, 2), New Drawing.Font(tipografia, 9, FontStyle.Bold), Brushes.Black, 270, Y, sf)
            Y += 15
            e.Graphics.DrawString("--------------------------------------------------------", New Drawing.Font(tipografia, 12, FontStyle.Regular), Brushes.Black, 1, Y)
            Y += 20

            e.Graphics.DrawString("EFECTIVO EN CAJA", New Drawing.Font(tipografia, 9, FontStyle.Bold), Brushes.Black, 1, Y)
            e.Graphics.DrawString(FormatNumber(EfectivoCajaG.Text, 2), New Drawing.Font(tipografia, 9, FontStyle.Bold), Brushes.Black, 270, Y, sf)
    ...
    Private Sub pCalculoGlobal58_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles pCalculoGlobal58.PrintPage
        ...
        Try
            ...
            e.Graphics.DrawString("Fecha: " & Format(dtpFecha.Value, "yyyy-MM-dd"), New Drawing.Font(tipografia, 6, FontStyle.Bold), Brushes.Black, 1, Y)
            e.Graphics.DrawString("Hora: " & Format(dtpHoraIni.Value, "HH:mm:ss"), New Drawing.Font(tipografia, 6, FontStyle.Bold), Brushes.Black, 180, Y, sf)
            Y += 15

            e.Graphics.DrawString("Fecha Fin: " & Format(dtpFechaFinal.Value, "yyyy-MM-dd"), New Drawing.Font(tipografia, 6, FontStyle.Bold), Brushes.Black, 1, Y)
            e.Graphics.DrawString("Hora FIn: " & Format(dtpHoraFin.Value, "HH:mm:ss"), New Drawing.Font(tipografia, 6, FontStyle.Bold), Brushes.Black, 180, Y, sf)
            Y += 15
            e.Graphics.DrawString("--------------------------------------------------------", New Drawing.Font(tipografia, 12, FontStyle.Regular), Brushes.Black, 1, Y)
            Y += 15
    ...
    Private Sub pCalculoUsuario80_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles pCalculoUsuario80.PrintPage
        ...
        Try
            ...
            e.Graphics.DrawString("--------------------------------------------------------", New Drawing.Font(tipografia, 12, FontStyle.Regular), Brushes.Black, 1, Y)
            Y += 18
            e.Graphics.DrawString("Usuario: " & cboUsuario.Text, fuente_datos, Brushes.Black, 270, Y, sf)
            Y += 17
            e.Graphics.DrawString("Desde: " & Format(dtpFechaIU.Value, "yyyy-MM-dd"), fuente_prods, Brushes.Black, 1, Y)
            e.Graphics.DrawString(Format(dtpHoraIU.Value, "HH:mm:ss"), fuente_prods2, Brushes.Black, 270, Y, sf)
            Y += 20

            e.Graphics.DrawString("Hasta: " & Format(dtpFechaFU.Value, "yyyy-MM-dd"), fuente_prods, Brushes.Black, 1, Y)
            e.Graphics.DrawString(Format(dtpHoraFU.Value, "HH:mm:ss"), fuente_prods2, Brushes.Black, 270, Y, sf)
            Y += 20
            e.Graphics.DrawString("--------------------------------------------------------", New Drawing.Font(tipografia, 12, FontStyle.Regular), Brushes.Black, 1, Y)
            Y += 20

            e.Graphics.DrawString("SALDO INICIAL", New Drawing.Font(tipografia, 9, FontStyle.Bold), Brushes.Black, 1, Y)
            e.Graphics.DrawString(simbolo & FormatNumber(txtSaldoUsuario.Text, 2), New Drawing.Font(tipografia, 9, FontStyle.Bold), Brushes.Black, 270, Y, sf)
            Y += 28

            e.Graphics.DrawString("TOTAL DE INGRESOS", New Drawing.Font(tipografia, 9, FontStyle.Bold), Brushes.Black, 1, Y)
            e.Graphics.DrawString(simbolo & FormatNumber(txtIngresosUsuario.Text, 2), New Drawing.Font(tipografia, 9, FontStyle.Bold), Brushes.Black, 270, Y, sf)
            Y += 15
            e.Graphics.DrawString(" ING. EFECTIVO", New Drawing.Font(tipografia, 9, FontStyle.Regular), Brushes.Black, 1, Y)
            e.Graphics.DrawString(FormatNumber(txtIngEfectivoU.Text, 2), fuente_prods, Brushes.Black, 270, Y, sf)
            Y += 15
            ...
            For lol = 0 To grdIngresos.Rows.Count - 1
                ...
                e.Graphics.DrawString(FormatNumber(MONTO, 2), fuente_prods, Brushes.Black, 270, Y, sf)
                Y += 15
            ...
            e.Graphics.DrawString("TOTAL DE EGRESOS", New Drawing.Font(tipografia, 9, FontStyle.Bold), Brushes.Black, 1, Y)
            e.Graphics.DrawString(simbolo & FormatNumber(txtEgresosUsuario.Text, 2), New Drawing.Font(tipografia, 9, FontStyle.Bold), Brushes.Black, 270, Y, sf)
            Y += 15
            e.Graphics.DrawString(" EGR. EFECTIVO", New Drawing.Font(tipografia, 9, FontStyle.Regular), Brushes.Black, 1, Y)
            e.Graphics.DrawString(FormatNumber(txtEgrEfectivoU.Text, 2), fuente_prods, Brushes.Black, 270, Y, sf)
            Y += 15
            ...
            For egreso80 = 0 To grdEgresos.Rows.Count - 1
                ...
                e.Graphics.DrawString(FormatNumber(MONTO80, 2), fuente_prods, Brushes.Black, 270, Y, sf)
                Y += 15
            ...
            e.Graphics.DrawString("SALDO FINAL", New Drawing.Font(tipografia, 9, FontStyle.Bold), Brushes.Black, 1, Y)
            e.Graphics.DrawString(simbolo & FormatNumber(txtSaldoFinalU.Text, 2), New Drawing.Font(tipografia, 9, FontStyle.Bold), Brushes.Black, 270, Y, sf)
            Y += 15
            e.Graphics.DrawString("--------------------------------------------------------", New Drawing.Font(tipografia, 12, FontStyle.Regular), Brushes.Black, 1, Y)
            Y += 21

            e.Graphics.DrawString("EFECTIVO EN CAJA", New Drawing.Font(tipografia, 9, FontStyle.Bold), Brushes.Black, 1, Y)
            e.Graphics.DrawString(FormatNumber(txtEfectivoCajaU.Text, 2), New Drawing.Font(tipografia, 9, FontStyle.Bold), Brushes.Black, 270, Y, sf)
            Y += 50
    ...
    Private Sub pCalculoUsuario58_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles pCalculoUsuario58.PrintPage
        ...
        Try
            ...
            Y += 15
            e.Graphics.DrawString("Desde: " & Format(dtpFecha.Value, "yyyy-MM-dd"), New Drawing.Font(tipografia, 6, FontStyle.Bold), Brushes.Black, 1, Y)
            e.Graphics.DrawString(Format(dtpHoraIni.Value, "HH:mm:ss"), New Drawing.Font(tipografia, 6, FontStyle.Bold), Brushes.Black, 180, Y, sf)
            Y += 15

            e.Graphics.DrawString("Hasta: " & Format(dtpFechaFU.Value, "yyyy-MM-dd"), New Drawing.Font(tipografia, 6, FontStyle.Bold), Brushes.Black, 1, Y)
            e.Graphics.DrawString(Format(dtpHoraFU, "HH:mm:ss"), New Drawing.Font(tipografia, 6, FontStyle.Bold), Brushes.Black, 180, Y, sf)
            Y += 15
            e.Graphics.DrawString("--------------------------------------------------------", New Drawing.Font(tipografia, 12, FontStyle.Regular), Brushes.Black, 1, Y)
            Y += 15
    ...
    Private Sub btnCierre_Click(sender As Object, e As EventArgs) Handles btnCierre.Click
        ...
        If txtNumCorte.Text = "" Then
            MsgBox("Procedimiento no valido, Falta número de corte.", vbInformation + vbOKOnly, "Delsscom Control Negocios 2022")
            Exit Sub
        End If
        ...
        Try
            ...
            cmd1 = cnn1.CreateCommand
            cmd1.CommandText = "update Compras set CorteU=" & txtNumCorte.Text & " where CorteU=0 AND FechaC BETWEEN '" & Format(dtpFechaIU.Value, "yyyy-MM-dd") & " " & Format(dtpHoraIU.Value, "HH:mm:ss") & "' AND '" & Format(dtpFechaFU.Value, "yyyy-MM-dd") & " " & Format(dtpHoraFU.Value, "HH:mm:ss") & "' AND Usuario='" & cboUsuario.Text & "'"
            cmd1.ExecuteNonQuery()

            cmd1 = cnn1.CreateCommand
            cmd1.CommandText = "update SaldosEmpleados set CorteU=" & txtNumCorte.Text & " where CorteU=0 AND Fecha BETWEEN '" & Format(dtpFechaIU.Value, "yyyy-MM-dd") & "' AND '" & Format(dtpFechaFU.Value, "yyyy-MM-dd") & "' and Usuario='" & cboUsuario.Text & "'"
            cmd1.ExecuteNonQuery()
            ...
            cmd1 = cnn1.CreateCommand
            cmd1.CommandText = "update Nominas set CorteU=" & txtNumCorte.Text & " where CorteU=0 AND Fecha BETWEEN '" & Format(dtpFechaIU.Value, "yyyy-MM-dd") & "' AND '" & Format(dtpFechaFU.Value, "yyyy-MM-dd") & "' and Usuario='" & cboUsuario.Text & "'"
            cmd1.ExecuteNonQuery()

            cmd1 = cnn1.CreateCommand
            cmd1.CommandText = "update OtrosGastos set CorteU=" & txtNumCorte.Text & " where CorteU=0 AND Fecha BETWEEN '" & Format(dtpFechaIU.Value, "yyyy-MM-dd") & "' AND '" & Format(dtpFechaFU.Value, "yyyy-MM-dd") & "' and Usuario='" & cboUsuario.Text & "'"
            cmd1.ExecuteNonQuery()

            If TipoCorte() = 1 Then
                cmd1 = cnn1.CreateCommand
                cmd1.CommandText = "update CorteUsuario set Calculo=" & CDbl(txtCalculo.Text) & ", Diferencia=" & CDbl(txtDiferencia.Text) & ", Saldo_Fin=" & CDbl(txtEnCaja.Text) & " where NumCorte=" & txtNumCorte.Text & " and Usuario='" & cboUsuario.Text & "'"
                cmd1.ExecuteNonQuery()
            Else
                cmd1 = cnn1.CreateCommand
                cmd1.CommandText = "update corteusuario set Calculo=0, Diferencia=0, Saldo_Fin=" & CDbl(txtEfectivoCajaU.Text) & " where NumCorte=" & txtNumCorte.Text & " and Usuario='" & cboUsuario.Text & "'"
                cmd1.ExecuteNonQuery()
            End If
            cnn1.Close()
    ...
    Private Sub PCierreUsuario80_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles PCierreUsuario80.PrintPage
        'Fuentes prederminadas
        Dim tipografia As String = "Lucida Sans Typewriter"
        Dim fuente_datos As New Drawing.Font(tipografia, 10, FontStyle.Regular)
        Dim fuente_prods As New Drawing.Font(tipografia, 9, FontStyle.Regular)
        ...
        Try
            ...
            Y += 18
            e.Graphics.DrawString("Desde: " & Format(dtpFechaIU.Value, "yyyy-MM-dd"), fuente_prods, Brushes.Black, 1, Y)
            e.Graphics.DrawString(Format(dtpHoraIU.Value, "HH:mm:ss"), fuente_datos, Brushes.Black, 270, Y, sf)
            Y += 20
            e.Graphics.DrawString("Hasta: " & Format(dtpFechaFU.Value, "yyyy-MM-dd"), fuente_prods, Brushes.Black, 1, Y)
            e.Graphics.DrawString(Format(dtpFechaIU.Value, "HH:mm:ss"), fuente_datos, Brushes.Black, 270, Y, sf)
            Y += 25
            e.Graphics.DrawString("Folios del " & Folio1 & "  al " & Folio2 & ".", fuente_prods, Brushes.Black, 1, Y)
            Y += 20
            e.Graphics.DrawString("--------------------------------------------------------", New Drawing.Font(tipografia, 12, FontStyle.Regular), Brushes.Black, 1, Y)
            Y += 20
            ...
            e.Graphics.DrawString("EFECTIVO EN CAJA", New Drawing.Font(tipografia, 9, FontStyle.Bold), Brushes.Black, 1, Y)
            e.Graphics.DrawString(simbolo & FormatNumber(txtEfectivoCajaU.Text, 2), New Drawing.Font(tipografia, 9, FontStyle.Bold), Brushes.Black, 270, Y, sf)
            Y += 20

            If TipoCorte() = 1 Then
                e.Graphics.DrawString("CÁLCULO", New Drawing.Font(tipografia, 9, FontStyle.Bold), Brushes.Black, 1, Y)
                e.Graphics.DrawString(simbolo & FormatNumber(txtCalculo.Text, 2), New Drawing.Font(tipografia, 9, FontStyle.Bold), Brushes.Black, 270, Y, sf)
                Y += 15
                e.Graphics.DrawString("DIFERENCIA", New Drawing.Font(tipografia, 9, FontStyle.Regular), Brushes.Black, 1, Y)
                e.Graphics.DrawString(simbolo & FormatNumber(txtDiferencia.Text, 2), fuente_prods, Brushes.Black, 270, Y, sf)
                Y += 15
            End If

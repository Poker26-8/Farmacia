...
Public Class frmProductosS
    ...
    Private Sub ShowData(ByVal tipo As String)
        Try
            ...
            If tipo = "BARRAS" Then
                cmd1.CommandText =
                    "select CodBarra,CodBarra1,CodBarra2,Codigo,Nombre,IVA,UVenta,PrecioCompra,PrecioVentaIVA,ProvPri,Departamento,Grupo,Ubicacion,ProvRes,UnidadSat,ClaveSat,Porcentaje,Unico,GPrint,Anti,Caduca from Productos where CodBarra='" & txtbarras.Text & "'"
            End If

            If tipo = "BARRAS1" Then
                cmd1.CommandText =
                    "select CodBarra,CodBarra1,CodBarra2,Codigo,Nombre,IVA,UVenta,PrecioCompra,PrecioVentaIVA,ProvPri,Departamento,Grupo,Ubicacion,ProvRes,UnidadSat,ClaveSat,Porcentaje,Unico,GPrint,Anti,Caduca from Productos where CodBarra1='" & txtBarras1.Text & "'"
            End If

            If tipo = "BARRAS2" Then
                cmd1.CommandText =
                    "select CodBarra,CodBarra1,CodBarra2,Codigo,Nombre,IVA,UVenta,PrecioCompra,PrecioVentaIVA,ProvPri,Departamento,Grupo,Ubicacion,ProvRes,UnidadSat,ClaveSat,Porcentaje,Unico,GPrint,Anti,Caduca from Productos where CodBarra2='" & txtBarras2.Text & "'"
            End If

            If tipo = "CODIGO" Then
                cmd1.CommandText =
                    "select CodBarra,CodBarra1,CodBarra2,Codigo,Nombre,IVA,UVenta,PrecioCompra,PrecioVentaIVA,ProvPri,Departamento,Grupo,Ubicacion,ProvRes,UnidadSat,ClaveSat,Porcentaje,Unico,GPrint,Anti,Caduca from Productos where Codigo='" & cboCodigo.Text & "'"
            End If
            If tipo = "PRODU" Then
                cmd1.CommandText =
                    "select CodBarra,CodBarra1,CodBarra2,Codigo,Nombre,IVA,UVenta,PrecioCompra,PrecioVentaIVA,ProvPri,Departamento,Grupo,Ubicacion,ProvRes,UnidadSat,ClaveSat,Porcentaje,Unico,GPrint,Anti,Caduca from Productos where Nombre='" & cboNombre.Text & "'"
            End If
    ...
    Private Sub ShowData2(ByVal tipo As String)
        Try
            ...
            If tipo = "BARRAS" Then
                cmd2.CommandText =
                    "select CodBarra,CodBarra1,CodBarra2,Codigo,Nombre,IVA,UVenta,PrecioCompra,PrecioVentaIVA,ProvPri,Departamento,Grupo,Ubicacion,ProvRes,UnidadSat,ClaveSat,Porcentaje,Unico,GPrint,Resumen,Descripcion_Tienda,Anti,Caduca from Productos where CodBarra='" & txtbarras.Text & "'"
            End If

            If tipo = "BARRAS1" Then
                cmd2.CommandText =
                    "select CodBarra,CodBarra1,CodBarra2,Codigo,Nombre,IVA,UVenta,PrecioCompra,PrecioVentaIVA,ProvPri,Departamento,Grupo,Ubicacion,ProvRes,UnidadSat,ClaveSat,Porcentaje,Unico,GPrint,Resumen,Descripcion_Tienda,Anti,Caduca from Productos where CodBarra1='" & txtBarras1.Text & "'"
            End If

            If tipo = "BARRAS2" Then
                cmd2.CommandText =
                    "select CodBarra,CodBarra1,CodBarra2,Codigo,Nombre,IVA,UVenta,PrecioCompra,PrecioVentaIVA,ProvPri,Departamento,Grupo,Ubicacion,ProvRes,UnidadSat,ClaveSat,Porcentaje,Unico,GPrint,Resumen,Descripcion_Tienda,Anti,Caduca from Productos where CodBarra2='" & txtBarras2.Text & "'"
            End If

            If tipo = "CODIGO" Then
                cmd2.CommandText =
                    "select CodBarra,CodBarra1,CodBarra2,Codigo,Nombre,IVA,UVenta,PrecioCompra,PrecioVentaIVA,ProvPri,Departamento,Grupo,Ubicacion,ProvRes,UnidadSat,ClaveSat,Porcentaje,Unico,GPrint,Resumen,Descripcion_Tienda,Anti,Caduca from Productos where Codigo='" & cboCodigo.Text & "'"
            End If
            If tipo = "PRODU" Then
                cmd2.CommandText =
                    "select CodBarra,CodBarra1,CodBarra2,Codigo,Nombre,IVA,UVenta,PrecioCompra,PrecioVentaIVA,ProvPri,Departamento,Grupo,Ubicacion,ProvRes,UnidadSat,ClaveSat,Porcentaje,Unico,GPrint,Resumen,Descripcion_Tienda,Anti,Caduca from Productos where Nombre='" & cboNombre.Text & "'"
            End If

...
Imports System.IO
Public Class frmProRefaccionaria
    Private Sub frmProRefaccionaria_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub txtbarras_GotFocus(sender As Object, e As EventArgs) Handles txtbarras.GotFocus
        txtbarras.SelectionStart = 0
        txtbarras.SelectionLength = Len(txtbarras.Text)
    End Sub

    Private Sub txtCodigoSAT_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txtCodigoSAT.KeyPress
        If AscW(e.KeyChar) = Keys.Enter Then
            txtClaveSAT.Focus().Equals(True)
        End If
    End Sub

    Private Sub txtClaveSAT_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txtClaveSAT.KeyPress
        If AscW(e.KeyChar) = Keys.Enter Then
    ...
    Private Sub cboCodigo_DropDown(sender As Object, e As EventArgs) Handles cboCodigo.DropDown
        ...
        Try
            ...
            Do While rd5.Read
                If rd5.HasRows Then
                    cboCodigo.Items.Add(rd5("Codigo").ToString)
                End If
            Loop
            rd5.Close()
            cnn5.Close()
    ...
    Private Sub cboNombre_DropDown(sender As Object, e As EventArgs) Handles cboNombre.DropDown
        ...
        Try
            cnn5.Close() : cnn5.Open()
            cmd5 = cnn5.CreateCommand
            cmd5.CommandText = "SELECT DISTINCT Nombre FROM Productos order by Nombre"
            rd5 = cmd5.ExecuteReader
            Do While rd5.Read
                If rd5.HasRows Then cboNombre.Items.Add(
                    rd5(0).ToString()
                    )
            Loop
    ...
    Private Sub cboNombre_GotFocus(sender As Object, e As EventArgs) Handles cboNombre.GotFocus
    ...
    Private Sub txtUnidad_GotFocus(sender As Object, e As EventArgs) Handles txtUnidad.GotFocus
    ...
    Private Sub txtpventa_GotFocus(sender As Object, e As EventArgs) Handles txtpventa.GotFocus
        txtpventa.SelectionStart = 0
        txtpventa.SelectionLength = Len(txtpventa.Text)
    End Sub

    Private Sub cboProvP_DropDown(sender As Object, e As EventArgs) Handles cboProvP.DropDown
        ...
        Try
            ...
            Do While rd5.Read
                If rd5.HasRows Then
                    cboProvP.Items.Add(rd5(0).ToString)
                End If
            Loop
            rd5.Close()
            cnn5.Close()
    ...
    Private Sub cboProvP_GotFocus(sender As Object, e As EventArgs) Handles cboProvP.GotFocus
        cboProvP.SelectionStart = 0
        cboProvP.SelectionLength = Len(cboProvP.Text)
    End Sub

    Private Sub cboProvP_KeyPress(sender As Object, e As KeyPressEventArgs) Handles cboProvP.KeyPress
        e.KeyChar = UCase(e.KeyChar)
        If AscW(e.KeyChar) = Keys.Enter Then
    ...
    Private Sub cboDepto_DropDown(sender As Object, e As EventArgs) Handles cboDepto.DropDown
        cboDepto.Items.Clear()
        Try
            cnn5.Close() : cnn5.Open()
            cmd5 = cnn5.CreateCommand
            cmd5.CommandText = "SELECT DISTINCT Departamento FROM productos WHERE Grupo<>'' order by Departamento"
            rd5 = cmd5.ExecuteReader
            Do While rd5.Read
                If rd5.HasRows Then
                    cboDepto.Items.Add(rd5(0).ToString)
                End If
            Loop
            rd5.Close()
            cnn5.Close()
    ...
    Private Sub cboDepto_KeyPress(sender As Object, e As KeyPressEventArgs) Handles cboDepto.KeyPress
        e.KeyChar = UCase(e.KeyChar)
        If AscW(e.KeyChar) = Keys.Enter Then
    ...
    Private Sub cboGrupo_DropDown(sender As Object, e As EventArgs) Handles cboGrupo.DropDown
        ...
        Try
            cnn5.Close() : cnn5.Open()
            cmd5 = cnn5.CreateCommand
            cmd5.CommandText = "SELECT DISTINCT Grupo FROM Productos WHERE Departamento='" & cboDepto.Text & "' AND Grupo<>'' order by Grupo"
            rd5 = cmd5.ExecuteReader
            Do While rd5.Read
                If rd5.HasRows Then
    ...
    Private Sub cboGrupo_GotFocus(sender As Object, e As EventArgs) Handles cboGrupo.GotFocus
    ...
    Private Sub btnImagen_Click(sender As Object, e As EventArgs) Handles btnImagen.Click
        Try
            If cboCodigo.Text = "" Then MsgBox("Necesitas seleccionar un producto para asignar una imagne.", vbInformation + vbOKOnly, titulocentral) : cboCodigo.Focus().Equals(True) : Exit Sub
            txtrutaimagen.Text = ""
            ...
            If rd1.HasRows Then
            Else
                MsgBox("Producto no válido.", vbInformation + vbOKOnly, titulocentral)
    ...
    Private Sub btnGuardar_Click(sender As Object, e As EventArgs) Handles btnGuardar.Click
        ...
        If cboCodigo.Text = "" Then MsgBox("El campo [Código] no puede estar vacío.", vbInformation + vbOKOnly, titulocentral) : cboCodigo.Focus().Equals(True) : Exit Sub
        If Len(cboCodigo.Text) > 6 Then MsgBox("El código corto debe de ser de 6 caracteres com máximo.", vbInformation + vbOKOnly, titulocentral) : cboCodigo.Focus().Equals(True) : Exit Sub
        If cboNombre.Text = "" Then MsgBox("Necesitas escribir el nombre del producto." & vbNewLine & "(Descripción corta para el ticket de venta)", vbInformation + vbOKOnly, titulocentral) : cboNombre.Focus().Equals(True)
        If cboIVA.Text = "" Then MsgBox("Selecciona un impuesto válido para el producto. Sí el producto no genera impuestos, selecciona '0'.", vbInformation + vbOKOnly, titulocentral) : cboIVA.Focus().Equals(True) : Exit Sub
        If txtUnidad.Text = "" Then MsgBox("Escribe la unidad de venta del producto para poder registrarlo.", vbInformation + vbOKOnly, titulocentral) : txtUnidad.Focus().Equals(True) : Exit Sub
        If txtpcompra.Text = "" Then MsgBox("El precio de compra del producto no puede estar vacío, por defecto '0'.", vbInformation + vbOKOnly, titulocentral) : txtpcompra.Focus().Equals(True) : Exit Sub
        If txtpventa.Text = "" Then MsgBox("El precio de venta del producto no puede estar vacío, por defecto '0'.", vbInformation + vbOKOnly, titulocentral) : txtpventa.Focus().Equals(True) : Exit Sub
        If cboProvP.Text = "" Then MsgBox("Selecciona un proveedor de tu catálogo para este producto.", vbInformation + vbOKOnly, titulocentral) : cboProvP.Focus().Equals(True) : Exit Sub
        If cboDepto.Text = "" Then MsgBox("Escribe o selecciona un deparatamento para el producto.", vbInformation + vbOKOnly, titulocentral) : cboDepto.Focus().Equals(True) : Exit Sub
        If cboGrupo.Text = "" Then MsgBox("Escribe o selecciona en grupo para el producto.", vbInformation + vbOKOnly, titulocentral) : cboGrupo.Focus().Equals(True) : Exit Sub
        ...
        crea_ruta("C:\ControlNegociosPro\ProductosImg" & baseseleccionada)
        If varrutabase <> "" Then
            crea_ruta("\\" & varrutabase & "\ControlNegociosPro\ProductosImg" & baseseleccionada)
        End If
                    ...
                    If cmd2.ExecuteNonQuery Then
                        ...
                        Else
                            If txtrutaimagen.Text <> "" Then
                                If varrutabase <> "" Then
                                    If File.Exists("\\" & varrutabase & "\ControlNegociosPro\ProductosImg" & baseseleccionada & "\" & cboCodigo.Text & ".jpg") Then
                                        File.Delete("\\" & varrutabase & "\ControlNegociosPro\ProductosImg" & baseseleccionada & "\" & cboCodigo.Text & ".jpg")
                                    End If
                                    picImagen.Image.Save("\\" & varrutabase & "\ControlNegociosPro\ProductosImg" & baseseleccionada & "\" & cboCodigo.Text & ".jpg", System.Drawing.Imaging.ImageFormat.Jpeg)
                                End If

                                If File.Exists("C:\ControlNegociosPro\ProductosImg" & baseseleccionada & "\" & cboCodigo.Text & ".jpg") Then
                                    File.Delete("C:\ControlNegociosPro\ProductosImg" & baseseleccionada & "\" & cboCodigo.Text & ".jpg")
                                End If
                                picImagen.Image.Save("C:\ControlNegociosPro\ProductosImg" & baseseleccionada & "\" & cboCodigo.Text & ".jpg", System.Drawing.Imaging.ImageFormat.Jpeg)
                            End If
                        End If
    ...
    Private Sub txtpcompra_Click(sender As Object, e As EventArgs) Handles txtpcompra.Click
        txtpcompra.SelectionStart = 0
        txtpcompra.SelectionLength = Len(txtpcompra.Text)
    End Sub

    Private Sub txtpcompra2_Click(sender As Object, e As EventArgs) Handles txtpcompra2.Click
        txtpcompra2.SelectionStart = 0
        txtpcompra2.SelectionLength = Len(txtpcompra2.Text)
    End Sub

    Private Sub txtpcompra2_GotFocus(sender As Object, e As EventArgs) Handles txtpcompra2.GotFocus
        txtpcompra2.SelectionStart = 0
        txtpcompra2.SelectionLength = Len(txtpcompra2.Text)
    End Sub

    Private Sub txtpcompra2_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txtpcompra2.KeyPress
        If Not IsNumeric(txtpcompra.Text) Then txtpcompra.Text = "0.00" : Exit Sub
        If Not IsNumeric(txtpcompra2.Text) Then txtpcompra2.Text = "0.00" : Exit Sub
        If AscW(e.KeyChar) = Keys.Enter Then
    ...
    Private Sub txtutilidad_Click(sender As Object, e As EventArgs) Handles txtutilidad.Click
        txtutilidad.SelectionStart = 0
        txtutilidad.SelectionLength = Len(txtutilidad.Text)
    End Sub

    Private Sub txtutilidad_GotFocus(sender As Object, e As EventArgs) Handles txtutilidad.GotFocus
        txtutilidad.SelectionStart = 0
        txtutilidad.SelectionLength = Len(txtutilidad.Text)
    End Sub
    ...
    Private Sub btnEliminar_Click(sender As Object, e As EventArgs) Handles btnEliminar.Click
        If cboCodigo.Text = "" Then MsgBox("Selecciona un producto para poder eliminarlo.", vbInformation + vbOKOnly, titulocentral) : cboCodigo.Focus().Equals(True) : Exit Sub
        If cboNombre.Text = "" Then MsgBox("Selecciona un producto para poder eliminarlo.", vbInformation + vbOKOnly, titulocentral) : cboNombre.Focus().Equals(True) : Exit Sub
        ...
        Try
            ...
            If rd1.HasRows Then
                ...
                End If
            Else
                MsgBox("No puedes eliminar un producto que no está registardo en el catálogo.", vbInformation + vbOKOnly, titulocentral)
                elimina = False
                rd1.Close() : cnn1.Close() : Exit Sub
            End If
            rd1.Close()
            ...
            If (elimina) Then
                ...
                If cmd1.ExecuteNonQuery Then
                    ...
                    Else
                        ...
                        End If
                    End If
                    MsgBox("Registro de producto eliminado.", vbInformation + vbOKOnly, titulocentral)
                End If

                cmd1 = cnn1.CreateCommand
                cmd1.CommandText = "DELETE FROM Kits WHERE Cod='" & cboCodigo.Text & "'"
                cmd1.ExecuteNonQuery()

                cmd1 = cnn1.CreateCommand
                cmd1.CommandText = "DELETE FROM Kits WHERE Codigo='" & cboCodigo.Text & "'"
                cmd1.ExecuteNonQuery()
    ...
    Private Function Comprueba(ByVal codigo As String, ByVal nombre As String, ByVal barras As String, ByVal provee As String, ByVal n_serie As String) As Boolean
        Try
            ...
            If rd2.HasRows Then
                If rd2.Read Then
                    MsgBox("Ya cuentas con un producto registrado con el código corto " & codigo & ".", vbInformation + vbOKOnly, titulocentral)
                    valida = False
                End If
            End If
            rd2.Close()
            ...
            If rd2.HasRows Then
                If rd2.Read Then
                    MsgBox("Ya cuentas con un producto registrado con el nombre " & nombre & ".", vbInformation + vbOKOnly, titulocentral)
                    valida = False
                End If
            End If
            rd2.Close()
            ...
            Else
                ...
                If rd2.HasRows Then
                    If rd2.Read Then
                        MsgBox("Ya cuentas con un producto registrado con el número de parte " & n_serie & ".", vbInformation + vbOKOnly, titulocentral)
                        valida = False
                    End If
                End If
                rd2.Close()

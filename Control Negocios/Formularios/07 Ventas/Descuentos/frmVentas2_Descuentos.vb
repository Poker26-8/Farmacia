...
Public Class frmVentas2_Descuentos
    ...
    Private Sub frmVentas2_Activated(sender As Object, e As System.EventArgs) Handles Me.Activated
        txtdia.Text = Weekday(Date.Now)
    End Sub
    Private Sub frmVentas2_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
    ...
    End Sub
    Private Sub frmVentas2_Shown(sender As Object, e As System.EventArgs) Handles Me.Shown
        cbodesc.Focus().Equals(True)
    End Sub
...
#Region "Funciones"
    Public Sub Folio()
        Try
            ...
            End If
            If Me.Text = "Cotización (2)" Or Me.Text = "Pedidos (2)" Then
                cmd9.CommandText =
...
#End Region
    ...
    Private Sub cbonota_DropDown(sender As System.Object, e As System.EventArgs) Handles cbonota.DropDown
        ...
        Try
            ...
            cmd1 = cnn1.CreateCommand
            cmd1.CommandText =
                "select Folio from Ventas where Status<>'CANCELADA' order by Folio"
            rd1 = cmd1.ExecuteReader
            Do While rd1.Read
    ...
    Private Sub Button7_Click(sender As System.Object, e As System.EventArgs) Handles Button7.Click
        VieneDe_Folios = "frmVentas2_Descuentos"
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        frmVentas3_Descuentos.Show()
        frmVentas3_Descuentos.BringToFront()
    End Sub
    ...
    Private Sub btnventa_Click(sender As System.Object, e As System.EventArgs) Handles btnventa.Click
            ...
            Select Case lblNumCliente.Text
                Case Is = "MOSTRADOR"
                    ...
                    If CDbl(txtdescuento1.Text) > 0 Then
                        ...
                        cmd1 = cnn1.CreateCommand
                        cmd1.CommandText =
                            "insert into Ventas(IdCliente,Cliente,Direccion,Subtotal,IVA,Totales,Descuento,Devolucion,ACuenta,Resta,Usuario,FVenta,HVenta,FPago,FCancelado,Status,Comisionista,Concepto,MontoSinDesc,FEntrega,Entrega,Comentario,StatusE,FolMonedero,CodFactura,IP,Formato,Fecha) values(" & IdCliente & ",'" & cboNombre.Text & "','" & txtdireccion.Text & "'," & SubTotal & "," & IVA_Vent & "," & Total_Ve & "," & Descuento & ",0," & ACuenta & "," & Resta & ",'" & lblusuario.Text & "','" & Format(Date.Now, "yyyy-MM-dd") & "','" & Format(Date.Now, "yyyy-MM-dd HH:mm:ss") & "','" & fecha_pago & "','','" & MyStatus & "','" & cbocomisionista.Text & "',''," & MontoSDesc & ",'" & Format(dtpFecha_E.Value, "dd/MM/yyyy") & "'," & IIf(Entrega = True, 1, 0) & ",'',0,'" & txtMonedero.Text & "','" & CodCadena & "','" & dameIP2() & "','" & cboimpresion.Text & "','" & Format(Date.Now, "yyyy-MM-dd HH:mm:ss") & "')"
                        cmd1.ExecuteNonQuery()
                        cnn1.Close()
                    Else
                ...
                Case Is <> "MOSTRADOR"
                    ...
                    cmd1 = cnn1.CreateCommand
                    cmd1.CommandText =
                        "insert into Ventas(IdCliente,Cliente,Direccion,Subtotal,IVA,Totales,Descuento,Devolucion,ACuenta,Resta,Usuario,FVenta,HVenta,FPago,FCancelado,Status,Comisionista,Concepto,MontoSinDesc,FEntrega,Entrega,Comentario,StatusE,FolMonedero,CodFactura,IP,Formato,Fecha) values(" & IdCliente & ",'" & cboNombre.Text & "','" & txtdireccion.Text & "'," & SubTotal & "," & IVA_Vent & "," & Total_Ve & "," & Descuento & ",0," & ACUenta2 & "," & Resta & ",'" & lblusuario.Text & "','" & Format(Date.Now, "yyyy-MM-dd") & "','" & Format(Date.Now, "yyyy-MM-dd HH:mm:ss") & "','" & fecha_pago & "','','" & MyStatus & "','" & cbocomisionista.Text & "',''," & MontoSDesc & ",'" & Format(dtpFecha_E.Value, "dd/MM/yyyy") & "'," & IIf(Entrega = True, 1, 0) & ",'',0,'" & txtMonedero.Text & "','" & CodCadena & "','" & dameIP2() & "','" & cboimpresion.Text & "','" & Format(Date.Now, "yyyy-MM-dd HH:mm:ss") & "')"
                    cmd1.ExecuteNonQuery()
                    cnn1.Close()
            End Select
        Catch ex As Exception
        ...
        Try
            ...
            If lblNumCliente.Text <> "MOSTRADOR" Then
                ...
                If CDbl(txtResta.Text) > 0 And CDbl(txtafavor.Text) > 0 And CDbl(txtPagar.Text) = CDbl(txtResta.Text) Then
                    cmd1 = cnn1.CreateCommand
                    cmd1.CommandText =
                        "insert into Abonoi(NumFolio,IdCliente,Cliente,Concepto,Fecha,Hora,Cargo,Abono,Saldo,Banco,Referencia,Usuario,MontoSF,Comentario) values(" & MYFOLIO & "," & IdCliente & ",'" & cboNombre.Text & "','NOTA VENTA','" & Format(Date.Now, "yyyy-MM-dd") & "','" & Format(Date.Now, "HH:mm:ss") & "'," & Total_Ve & ",0," & MySaldo & ",'','','" & lblusuario.Text & "'," & Resta & ",'')"
                    cmd1.ExecuteNonQuery()
                Else
                    cmd1 = cnn1.CreateCommand
                    cmd1.CommandText =
                ...
                If EfectivoX > 0 Then
                    Select Case lblNumCliente.Text
                        Case Is = "MOSTRADOR"
                            cmd1 = cnn1.CreateCommand
                            cmd1.CommandText =
                            "insert into Abonoi(NumFolio,IdCliente,Cliente,Concepto,Fecha,Hora,Cargo,Abono,Saldo,FormaPago,Monto,Banco,Referencia,Usuario,MontoSF,Comentario,CuentaC,BRecepcion,Descuento) values(" & MYFOLIO & ",0,'" & cboNombre.Text & "','ABONO','" & Format(Date.Now, "yyyy-MM-dd") & "','" & Format(Date.Now, "HH:mm:ss") & "',0," & EfectivoX & ",0,'EFECTIVO'," & EfectivoX & ",'','','" & lblusuario.Text & "',0,'','',''," & Descuento & ")"
                            cmd1.ExecuteNonQuery()
                        ...
                        Case Is <> "MOSTRADOR"
                            ...
                            If CDbl(txtResta.Text) > 0 And CDbl(txtafavor.Text) > 0 Then
                                cmd1 = cnn1.CreateCommand
                                cmd1.CommandText =
                                "insert into Abonoi(NumFolio,IdCliente,Cliente,Concepto,Fecha,Hora,Cargo,Abono,Saldo,FormaPago,Monto,Banco,Referencia,Usuario,MontoSF,Comentario,CuentaC,BRecepcion,Descuento) values(" & MYFOLIO & "," & IdCliente & ",'" & cboNombre.Text & "','ABONO','" & Format(Date.Now, "yyyy-MM-dd") & "','" & Format(Date.Now, "HH:mm:ss") & "',0," & EfectivoX & "," & MySaldo & ",'EFECTIVO'," & EfectivoX & ",'','','" & lblusuario.Text & "'," & Resta & ",'','',''," & Descuento & ")"
                                cmd1.ExecuteNonQuery()
                            Else
                                cmd1 = cnn1.CreateCommand
                                cmd1.CommandText =
                                "insert into Abonoi(NumFolio,IdCliente,Cliente,Concepto,Fecha,Hora,Cargo,Abono,Saldo,FormaPago,Monto,Banco,Referencia,Usuario,Comentario,CuentaC,BRecepcion,Descuento) values(" & MYFOLIO & "," & IdCliente & ",'" & cboNombre.Text & "','ABONO','" & Format(Date.Now, "yyyy-MM-dd") & "','" & Format(Date.Now, "HH:mm:ss") & "',0," & EfectivoX & "," & MySaldo & ",'EFECTIVO'," & EfectivoX & ",'','','" & lblusuario.Text & "','','',''," & Descuento & ")"
                                cmd1.ExecuteNonQuery()
                            End If
                    End Select
                End If
        ...
        Try
            ...
            For R As Integer = 0 To grdcaptura.Rows.Count - 1
                ...
                cmd1 = cnn1.CreateCommand
                cmd1.CommandText =
                    "select Departamento,Grupo,ProvRes,MCD,Multiplo,Unico,Departamento from Productos where Codigo='" & mycode & "'"
                rd1 = cmd1.ExecuteReader
                If rd1.HasRows Then
                    If rd1.Read Then
                        MyCostVUE = 0
    ...
    Public Sub Insert_Pedido()
        ...
        With oData
            If .dbOpen(a_cnn, Direcc_Access, sInfo) Then
                ...
                If .runSp(a_cnn, "insert into CotPed(idCliente,Nombre,Direccion,Totales,Descuento,ACuenta,Resta,Usuario,FVenta,HVenta,Status,MontoSnDesc,Comentario,Telefono) values(0,'" & cboNombre.Text & "','" & EliminarSaltosLinea(txtdireccion.Text, " ") & "',0,0,0,0,'" & lblusuario.Text & "',#" & FormatDateTime(Date.Now, DateFormat.ShortDate) & "#,#" & FormatDateTime(Date.Now, DateFormat.ShortTime) & "#,'PEDIDO',0,'" & txtcomentario.Text & "','" & tel_cliente & "')", sInfo) Then
                    sInfo = ""
                Else
                    MsgBox(sInfo)
                End If
...
doorcita:
    ...
    Private Sub btnpedido_Click(sender As System.Object, e As System.EventArgs) Handles btnpedido.Click
        Me.Text = "Pedidos (2)"
        If Me.Text = "Ventas (2)" Or Me.Text = "Cotización (2)" Then
            btnnuevo.PerformClick()
        ...
        ElseIf Me.Text = "Pedidos (2)" Then
            ...
            If lblusuario.Text = "" Then MsgBox("Escribe tu contraseña para continuar con el pedido.", vbInformation + vbOKOnly, "Delsscom Control Negocios Pro") : txtcontraseña.Focus().Equals(True) : Exit Sub
            ...
            If ACuenta > 0 Then
                ...
                cmd1 = cnn1.CreateCommand
                cmd1.CommandText =
                    "insert into AbonoI(NumFolio,IdCliente,Cliente,Concepto,Fecha,Hora,Cargo,Abono,Saldo,Efectivo,Tarjeta,Transfe,Monedero,Otro,Banco,Referencia,Usuario,MontoSF) values(" & MYFOLIO & "," & idCliente & ",'" & Cliente & "','ANTICIPO','" & Format(Date.Now, "yyyy-MM-dd") & "','" & Format(Date.Now, "HH:mm:ss") & "',0," & ACuenta & "," & MySaldo & "," & EfectivoX & "," & TotTarjeta & "," & TotTransfe & "," & TotMonedero & "," & TotOtros & ",'','','" & lblusuario.Text & "',0)"
                cmd1.ExecuteNonQuery()
            End If
            cnn1.Close()
...
ecomoda:
    ...
    Private Sub pVenta80_PrintPage(sender As System.Object, e As System.Drawing.Printing.PrintPageEventArgs) Handles pVenta80.PrintPage
        ...
        Try
            ...
            Dim montoformap As Double = 0

            If CDbl(txtMontoP.Text) > 0 Then
                For r As Integer = 0 To grdpago.Rows.Count - 1

                    formapagop = grdpago.Rows(r).Cells(0).Value.ToString
                    montoformap = grdpago.Rows(r).Cells(3).Value.ToString

                    If montoformap > 0 Then
                        e.Graphics.DrawString("Pago con " & formapagop & "", fuente_prods, Brushes.Black, 1, Y)
                        e.Graphics.DrawString(simbolo & FormatNumber(montoformap, 2), fuente_prods, Brushes.Black, 285, Y, sf)
                        Y += 13.5
                    End If
        ...
        Try
            ...
            If cboNombre.Text <> "" Then
                ...
                If txtdireccion.Text <> "" Then
                    ...
                    Y += 12
                    If Mid(txtdireccion.Text, 28, 56) <> "" Then
                        e.Graphics.DrawString(Mid(txtdireccion.Text, 28, 56), fuente_prods, Brushes.Black, 1, Y)
                        Y += 12
                    End If
                    If Mid(txtdireccion.Text, 56, 84) <> "" Then
                        e.Graphics.DrawString(Mid(txtdireccion.Text, 56, 84), fuente_prods, Brushes.Black, 1, Y)
                        Y += 12
                    End If
                End If
                Y += 8
            ...
            e.Graphics.DrawString("--------------------------------------------------------", New Drawing.Font(tipografia, 12, FontStyle.Regular), Brushes.Black, 1, Y)
            Y += 14
            e.Graphics.DrawString("TOTAL DE PRODUCTOS " & total_prods, New Drawing.Font(tipografia, 6, FontStyle.Bold), Brushes.Black, 90, Y, sc)
            Y += 7
            e.Graphics.DrawString("--------------------------------------------------------", New Drawing.Font(tipografia, 12, FontStyle.Regular), Brushes.Black, 1, Y)
            Y += 13
            ...
            Dim montoforma As Double = 0

            If CDbl(txtMontoP.Text) > 0 Then
                For r As Integer = 0 To grdpago.Rows.Count - 1

                    formapago = grdpago.Rows(r).Cells(0).Value.ToString
                    montoforma = grdpago.Rows(r).Cells(3).Value.ToString
            ...
            Y += 12
            If Mid(Pie, 28, 56) <> "" Then
                e.Graphics.DrawString(Mid(Pie, 28, 56), fuente_prods, Brushes.Black, 90, Y, sc)
                Y += 12
            End If
            If Mid(Pie, 56, 84) <> "" Then
                e.Graphics.DrawString(Mid(Pie, 56, 84), fuente_prods, Brushes.Black, 90, Y, sc)
                Y += 12
            End If
            Y += 15
    ...
    Private Sub pPedido58_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles pPedido58.PrintPage
        ...
        Try
            ...
            For miku As Integer = 0 To grdcaptura.Rows.Count - 1
                ...
                If Mid(nombre, 1, 25) <> "" Then
                    e.Graphics.DrawString(Mid(nombre, 1, 25), fuente_prods, Brushes.Black, 33, Y)
                    Y += 12
                End If

                If Mid(nombre, 26, 50) <> "" Then
                    e.Graphics.DrawString(Mid(nombre, 26, 51), fuente_prods, Brushes.Black, 33, Y)
                    Y += 12
                End If
                If Mid(nombre, 52, 76) <> "" Then
                    e.Graphics.DrawString(Mid(nombre, 52, 76), fuente_prods, Brushes.Black, 33, Y)
                    Y += 12
                End If
                'e.Graphics.DrawString(Mid(nombre, 1, 28), fuente_prods, Brushes.Black, 52, Y)
                Y += 12

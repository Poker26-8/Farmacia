                    ...
                    If rd1.Read Then
                        ...
                        Do While rd2.Read
                            If rd2.HasRows Then
                                ...
                                grdcaptura.Rows.Add(codigo, nombre, unidad, cantidad, FormatNumber(precio, 2), descue, FormatNumber(total, 2))
                                If comentario <> "" Then
...
doorcita:
    ...
    Private Sub pVentas80_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles pVentas80.PrintPage
        ...
        Try
            ...
            e.Graphics.DrawString("--------------------------------------------------------", New Drawing.Font(tipografia, 12, FontStyle.Regular), Brushes.Black, 1, Y)
            Y += 15
            e.Graphics.DrawString("COPIA DE NOTA DE VENTA", New Drawing.Font(tipografia, 12, FontStyle.Bold), Brushes.Black, 140, Y, sc)
            Y += 12
            e.Graphics.DrawString("--------------------------------------------------------", New Drawing.Font(tipografia, 12, FontStyle.Regular), Brushes.Black, 1, Y)
            Y += 18
    ...
    Private Sub pCotiz80_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles pCotiz80.PrintPage
        ...
        Try
            ...
            If TipoVenta = 5 Then
                e.Graphics.DrawString("--------------------------------------------------------", New Drawing.Font(tipografia, 12, FontStyle.Regular), Brushes.Black, 1, Y)
                Y += 15
                e.Graphics.DrawString("COPIA COTIZACIÓN", New Drawing.Font(tipografia, 12, FontStyle.Bold), Brushes.Black, 140, Y, sc)
                Y += 12
                e.Graphics.DrawString("--------------------------------------------------------", New Drawing.Font(tipografia, 12, FontStyle.Regular), Brushes.Black, 1, Y)
                Y += 18
            End If
    ...
    Private Sub pDevos80_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles pDevos80.PrintPage
        ...
        Try
            ...
            e.Graphics.DrawString("--------------------------------------------------------", New Drawing.Font(tipografia, 12, FontStyle.Regular), Brushes.Black, 1, Y)
            Y += 15
            e.Graphics.DrawString("COPIA DEVOLUCIÓN", New Drawing.Font(tipografia, 12, FontStyle.Bold), Brushes.Black, 140, Y, sc)
            Y += 12
            e.Graphics.DrawString("--------------------------------------------------------", New Drawing.Font(tipografia, 12, FontStyle.Regular), Brushes.Black, 1, Y)
            Y += 18
    ...
    Private Sub PCAbono80_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles PCAbono80.PrintPage
        ...
        Try
            ...
            e.Graphics.DrawString("--------------------------------------------------------", New Drawing.Font(tipografia, 12, FontStyle.Regular), Brushes.Black, 1, Y)
            Y += 15
            e.Graphics.DrawString("COPIA DE NOTA DE ABONO", New Drawing.Font(tipografia, 12, FontStyle.Bold), Brushes.Black, 140, Y, sc)
            Y += 12
            e.Graphics.DrawString("--------------------------------------------------------", New Drawing.Font(tipografia, 12, FontStyle.Regular), Brushes.Black, 1, Y)
            Y += 18

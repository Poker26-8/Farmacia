...
Public Class frmVentas1_Partes
...
#Region "Funciones"
    Public Sub Folio()
        Try
            ...
            If Me.Text = "Ventas Partes" Then
                cmd9.CommandText =
                    "select MAX(Folio) from Ventas"
            End If
            If Me.Text = "Cotización Partes" Or Me.Text = "Pedidos Partes" Then
                cmd9.CommandText =
                ...
                If grdcaptura.Rows.Count <> 0 Then
                    For ter As Integer = 0 To grdcaptura.Rows.Count - 1
                        ...
                        If grdcaptura.Rows(ter).Cells(0).Value.ToString = codigo Then
                            'El lote es igual
                            If grdcaptura.Rows(ter).Cells(8).Value.ToString() = lote Then
    ...
    Private Sub cbodesc_KeyDown(sender As System.Object, e As System.Windows.Forms.KeyEventArgs) Handles cbodesc.KeyDown
        Select Case e.KeyCode
            Case Is = Keys.F2
                ...
                End If
            Case Is = Keys.F3
                frmBuscaVentas.Vienna = "Ventas Partes"
                frmBuscaVentas.Show()
            Case Is = Keys.F5
...
kaka:
    ...
    Private Sub cbocodigo_KeyPress(sender As Object, e As System.Windows.Forms.KeyPressEventArgs) Handles cbocodigo.KeyPress
        ...
        If AscW(e.KeyChar) = Keys.Enter And (cbocodigo.Text = "" And cbodesc.Text = "") Then
            ...
            End If
            If Me.Text = "Cotización Partes" Then
                Button3.Focus().Equals(True)
            End If
            If Me.Text = "Pedido Partes" Then
    ...
    Private Sub Button9_Click(sender As System.Object, e As System.EventArgs) Handles Button9.Click
        ...
        grdpago.Rows.Add(tpago, banco, refe, monto, fecha, comentario, cuentar, bancorep, txtvalor.Text, txtequivale.Text, txtmonto)
        grdpago.Refresh()
...
doorcita:
    ...
    Private Sub Button3_Click(sender As System.Object, e As System.EventArgs) Handles Button3.Click
        Me.Text = "Cotización Partes"
        If Me.Text = "Ventas Partes" Or Me.Text = "Pedidos Partes" Then
            btnnuevo.PerformClick()
            ...
            cboNombre.Focus().Equals(True)
        ElseIf Me.Text = "Cotización Partes" Then
...
doorcita:
    ...
    Private Sub btnventa_Click(sender As System.Object, e As System.EventArgs) Handles btnventa.Click
        ...
        If modo_caja = "CAJA" Then
            If (cboNombre.Text = "" Or cboNombre.Text = "PUBLICO EN GENERAL") And CDbl(IIf(txtResta.Text = "", "0", txtResta.Text)) <> 0 Then
        ...
        'Valida el cliente para saber sí existe o no en el catálogo
        Try
            If cboNombre.Text = "" Then
                IdCliente = 0
                Cliente = ""
        ...
        'Contraseña y permisos de usuario para realizar la venta
        Dim per_venta As Boolean = False
        ...
        CodCadena = Dame_FolioFac(lblfolio.Text)
            ...
            Select Case lblNumCliente.Text
                Case Is = "MOSTRADOR"
                    ...
                    If CDbl(txtdescuento1.Text) > 0 Then
                        ...
                        cmd1 = cnn1.CreateCommand
                        cmd1.CommandText =
                            "insert into Ventas(IdCliente,Cliente,Direccion,Subtotal,IVA,Totales,Descuento,Devolucion,ACuenta,Resta,Usuario,FVenta,HVenta,FPago,FCancelado,Status,Comisionista,Concepto,MontoSinDesc,FEntrega,Entrega,Comentario,StatusE,FolMonedero,CodFactura,IP,Formato,Franquicia) values(" & IdCliente & ",'" & cboNombre.Text & "','" & txtdireccion.Text & "'," & SubTotal & "," & IVA_Vent & "," & Total_Ve & "," & Descuento & ",0," & ACuenta & "," & Resta & ",'" & lblusuario.Text & "','" & Format(Date.Now, "yyyy-MM-dd") & "','" & Format(Date.Now, "yyyy-MM-dd HH:mm:ss") & "','" & fecha_pago & "','','" & MyStatus & "','" & cbocomisionista.Text & "',''," & MontoSDesc & ",'" & Format(dtpFecha_E.Value, "dd/MM/yyyy") & "'," & IIf(Entrega = True, 1, 0) & ",'',0,'" & txtMonedero.Text & "','" & CodCadena & "','" & dameIP2() & "','" & cboimpresion.Text & "', " & validafranquicia & ")"
                        cmd1.ExecuteNonQuery()
                        cnn1.Close()
                    Else
                ...
                Case Is <> "MOSTRADOR"
                    ...
                    cmd1 = cnn1.CreateCommand
                    cmd1.CommandText =
                        "insert into Ventas(IdCliente,Cliente,Direccion,Subtotal,IVA,Totales,Descuento,Devolucion,ACuenta,Resta,Usuario,FVenta,HVenta,FPago,FCancelado,Status,Comisionista,Concepto,MontoSinDesc,FEntrega,Entrega,Comentario,StatusE,FolMonedero,CodFactura,IP,Formato,Franquicia) values(" & IdCliente & ",'" & cboNombre.Text & "','" & txtdireccion.Text & "'," & SubTotal & "," & IVA_Vent & "," & Total_Ve & "," & Descuento & ",0," & ACUenta2 & "," & Resta & ",'" & lblusuario.Text & "','" & Format(Date.Now, "yyyy-MM-dd") & "','" & Format(Date.Now, "yyyy-MM-dd HH:mm:ss") & "','" & fecha_pago & "','','" & MyStatus & "','" & cbocomisionista.Text & "',''," & MontoSDesc & ",'" & Format(dtpFecha_E.Value, "dd/MM/yyyy") & "'," & IIf(Entrega = True, 1, 0) & ",'',0,'" & txtMonedero.Text & "','" & CodCadena & "','" & dameIP2() & "','" & cboimpresion.Text & "'," & validafranquicia & ")"
                    cmd1.ExecuteNonQuery()
                    cnn1.Close()
            End Select
        Catch ex As Exception
        ...
        Try
            ...
            If lblNumCliente.Text <> "MOSTRADOR" Then
                ...
                '-------------------------------------------------abono en separaciones---------------------------------
                'El primer abono es el de la venta, no mete pagos
                    ...
                    For t As Integer = 0 To grdpago.Rows.Count - 1
                        ...
                        Select Case lblNumCliente.Text
                            Case Is = "MOSTRADOR"
                                cmd1 = cnn1.CreateCommand
                                cmd1.CommandText =
                                    "insert into AbonoI(NumFolio,IdCliente,Cliente,Concepto,Fecha,Hora,Cargo,Abono,Saldo,FormaPago,Monto,Banco,Referencia,Usuario,MontoSF,Comentario,CuentaC,BRecepcion) values(" & MYFOLIO & ",0,'" & cboNombre.Text & "','ABONO','" & Format(Date.Now, "yyyy-MM-dd") & "','" & Format(Date.Now, "HH:mm:ss") & "',0," & MontoP & ",0,'" & FormaP & "'," & MontoP & ",'" & BancoP & "','" & RefeP & "','" & lblusuario.Text & "',0,'" & comentario & "','" & cuentarep & "','" & bancorep & "')"
                                cmd1.ExecuteNonQuery()
                            Case Is <> "MOSTRADOR"
                                cmd1 = cnn1.CreateCommand
                                cmd1.CommandText =
                                ...
                                If CDbl(txtResta.Text) > 0 And CDbl(txtafavor.Text) > 0 Then
                                    cmd1 = cnn1.CreateCommand
                                    cmd1.CommandText =
                                        "insert into Abonoi(NumFolio,IdCliente,Cliente,Concepto,Fecha,Hora,Cargo,Abono,Saldo,FormaPago,Monto,Banco,Referencia,Usuario,MontoSF,Comentario,CuentaC,BRecepcion) values(" & MYFOLIO & "," & IdCliente & ",'" & cboNombre.Text & "','ABONO','" & Format(Date.Now, "yyyy-MM-dd") & "','" & Format(Date.Now, "HH:mm:ss") & "',0," & MontoP & "," & MySaldo & ",'" & FormaP & "'," & MontoP & ",'" & BancoP & "','" & RefeP & "','" & lblusuario.Text & "'," & Resta & ",'" & comentario & "','" & cuentarep & "','" & bancorep & "')"
                                    cmd1.ExecuteNonQuery()
                                Else
                                    cmd1 = cnn1.CreateCommand
                                    cmd1.CommandText =
                                        "insert into Abonoi(NumFolio,IdCliente,Cliente,Concepto,Fecha,Hora,Cargo,Abono,Saldo,FormaPago,Monto,Banco,Referencia,Usuario,Comentario,CuentaC,BRecepcion) values(" & MYFOLIO & "," & IdCliente & ",'" & cboNombre.Text & "','ABONO','" & Format(Date.Now, "yyyy-MM-dd") & "','" & Format(Date.Now, "HH:mm:ss") & "',0," & MontoP & "," & MySaldo & ",'" & FormaP & "'," & MontoP & ",'" & BancoP & "','" & RefeP & "','" & lblusuario.Text & "','" & comentario & "','" & cuentarep & "','" & bancorep & "')"
                                    cmd1.ExecuteNonQuery()
                                End If
                        End Select
                    Next
                    ...
                    Select Case lblNumCliente.Text
                        ...
                        Case Is <> "MOSTRADOR"
                            ...
                            If CDbl(txtResta.Text) > 0 And CDbl(txtafavor.Text) > 0 Then
                                cmd1 = cnn1.CreateCommand
                                cmd1.CommandText =
                                "insert into Abonoi(NumFolio,IdCliente,Cliente,Concepto,Fecha,Hora,Cargo,Abono,Saldo,FormaPago,Monto,Banco,Referencia,Usuario,MontoSF,Comentario,CuentaC,BRecepcion) values(" & MYFOLIO & "," & IdCliente & ",'" & cboNombre.Text & "','ABONO','" & Format(Date.Now, "yyyy-MM-dd") & "','" & Format(Date.Now, "HH:mm:ss") & "',0," & EfectivoX & "," & MySaldo & ",'EFECTIVO'," & EfectivoX & ",'','','" & lblusuario.Text & "'," & Resta & ",'','','')"
                                cmd1.ExecuteNonQuery()
                            Else
                                cmd1 = cnn1.CreateCommand
                                cmd1.CommandText =
                                "insert into Abonoi(NumFolio,IdCliente,Cliente,Concepto,Fecha,Hora,Cargo,Abono,Saldo,FormaPago,Monto,Banco,Referencia,Usuario,Comentario,CuentaC,BRecepcion) values(" & MYFOLIO & "," & IdCliente & ",'" & cboNombre.Text & "','ABONO','" & Format(Date.Now, "yyyy-MM-dd") & "','" & Format(Date.Now, "HH:mm:ss") & "',0," & EfectivoX & "," & MySaldo & ",'EFECTIVO'," & EfectivoX & ",'','','" & lblusuario.Text & "','','','')"
                                cmd1.ExecuteNonQuery()
                            End If
                    End Select
                End If
...
doorcita:
    ...
    Private Sub btnpedido_Click(sender As System.Object, e As System.EventArgs) Handles btnpedido.Click
        Try
            ...
            Me.Text = "Pedidos Partes"
            If Me.Text = "Ventas Partes" Or Me.Text = "Cotización Partes" Then
                btnnuevo.PerformClick()
            ...
            ElseIf Me.Text = "Pedidos Partes" Then
...
ecomoda:
    ...
    Private Sub pCotiza80_PrintPage(sender As System.Object, e As System.Drawing.Printing.PrintPageEventArgs) Handles pCotiza80.PrintPage
        ...
        Try
                    ...
                    If rd1.HasRows Then
                        If rd1.Read Then
                            If rd1(0).ToString > 0 Then
                                ...
                                ivarestante = CDbl(MySubtotal) - CDbl(ivaproducto)

                                TotalIVAPrint = TotalIVAPrint + CDbl(ivarestante)
                            End If
            ...
            If DesglosaIVA = "1" Then
                If TotalIVAPrint > 0 Then
                    If TotalIVAPrint > 0 And TotalIVAPrint <> CDbl(txtPagar.Text) Then
                        Y += 12
                        e.Graphics.DrawString("*** IVA 16%", New Drawing.Font(tipografia, 8, FontStyle.Regular), Brushes.Black, 1, Y)
                    ...
                    If rd1.HasRows Then
                        If rd1.Read Then
                            If rd1(0).ToString > 0 Then
                                MySubtotal = grdcaptura.Rows(N).Cells(5).Value.ToString
                                ivaproducto = MySubtotal / (1 + rd1(0).ToString)
                                restaiva = CDbl(MySubtotal) - CDbl(ivaproducto)
    ...
    Private Sub txtdireccion_med_GotFocus(sender As Object, e As System.EventArgs) Handles txtdireccion_med.GotFocus
        ...
        txtdireccion_med.SelectionLength = Len(txtdireccion_med.Text)
    End Sub
    Private Sub txtdireccion_med_KeyPress(sender As Object, e As System.Windows.Forms.KeyPressEventArgs) Handles txtdireccion_med.KeyPress
        If AscW(e.KeyChar) = Keys.Enter Then
                    ...
                    If rd1.HasRows Then
                        If rd1.Read Then
                            If rd1(0).ToString > 0 Then
                                MySubtotal = grdcaptura.Rows(N).Cells(5).Value.ToString
                                ivaproducto = MySubtotal / (1 + rd1(0).ToString)
                                restaiva = CDbl(MySubtotal) - CDbl(MySubtotal)
                                TotalIVAPrint = TotalIVAPrint + CDbl(restaiva)
                            End If
                            If CDbl(grdcaptura.Rows(N).Cells(10).Value.ToString) <> 0 Then
                                TotalIEPS = TotalIEPS + CDbl(grdcaptura.Rows(N).Cells(10).Value.ToString)

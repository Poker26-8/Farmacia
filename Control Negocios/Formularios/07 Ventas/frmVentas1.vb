...
Public Class frmVentas1
    ...
    End Sub
    Public Async Sub frmVentas1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.KeyPreview = True
    ...
    Private Sub frmVentas1_Shown(sender As Object, e As EventArgs) Handles Me.Shown
...
doorcita:
    ...
    Public Sub cboNombre_KeyPress(sender As Object, e As KeyPressEventArgs) Handles cboNombre.KeyPress
                ...
                If Resta_ventas > 0 Then
                    If Resta_ventas >= Total_devo Then
                        ...
                        If lblNumCliente.Text <> "MOSTRADOR" Then
                            ...
                            cmd1 = cnn1.CreateCommand
                            cmd1.CommandText =
                                "insert into AbonoI(NumFolio,IdCliente,Cliente,Concepto,Fecha,Hora,FechaCompleta,Cargo,Abono,Saldo,Monto,Banco,Referencia,Usuario,Corte,CorteU,Cargado,MontoSF) values(" & cbonota.Text & "," & lblNumCliente.Text & ",'" & cboNombre.Text & "','DEVOLUCION','" & Format(Date.Now, "yyyy-MM-dd") & "','" & Format(Date.Now, "HH:mm:ss") & "','" & Format(Date.Now, "yyyy-MM-dd HH:mm:ss") & "',0," & Total_devo & "," & (MySaldo + Total_devo) & "," & Total_devo & ",'','','" & lblusuario.Text & "',0,0,0,0)"
                            cmd1.ExecuteNonQuery()
    ...
    Private Sub pVenta80_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles pVenta80.PrintPage
        ...
        Try
            ...
            For miku As Integer = 0 To grdcaptura.Rows.Count - 1
                ...
                Dim barras As String = IIf(grdcaptura.Rows(miku).Cells(15).Value = "", "", grdcaptura.Rows(miku).Cells(15).Value)
                Dim lote As String = ""

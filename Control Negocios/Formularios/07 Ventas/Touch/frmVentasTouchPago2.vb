Public Class frmVentasTouchPago2
    ...
    Private Sub Button23_Click(sender As System.Object, e As System.EventArgs) Handles btnIntro.Click
        frmVentasTouch2.MontoEfectivo = txtefectivo.Text
        frmVentasTouch2.MontoTarjeta = txttarjeta.Text
        frmVentasTouch2.MontoMonedero = txtmone.Text
        frmVentasTouch2.Cambio = txtcambio.Text
        frmVentasTouch2.Resta = txtresta.Text
        frmVentasTouch2.Cliente = cboNombre.Text
        frmVentasTouch2.Id_Cliente = MyIdCliente
        frmVentasTouch2.Direccion = txtDireccion.Text
        frmVentasTouch2.Monedero = txtMonedero.Text
        Dim cuantopaga As Double = 0
        cuantopaga = txttarjeta.Text
        frmVentasTouch2.validaTarjeta = cuantopaga
        Refresh()
        frmVentasTouch2.GuardarVenta()
    End Sub
    ...
    Private Sub cboNombre_SelectedValueChanged(sender As System.Object, e As System.EventArgs) Handles cboNombre.SelectedValueChanged
        ...
        If rd1.HasRows Then
            If rd1.Read Then
                ...
                frmVentasTouch2.lbltipoventa.Text = MyIdCliente
        ...
        rd1.Close()
        cnn1.Close()
        If cboNombre.Text = "" Then frmVentasTouch2.lbltipoventa.Text = "MOSTRADOR" : MyIdCliente = 0
        txtDireccion.Focus().Equals(True)
        Exit Sub
345:

Public Class frmVentasTouchPago
    Dim Foco As Byte = 0
    ...
    Private Sub Button23_Click(sender As System.Object, e As System.EventArgs) Handles btnIntro.Click
        frmVentasTouch.MontoEfectivo = txtefectivo.Text
        frmVentasTouch.MontoTarjeta = txttarjeta.Text
        frmVentasTouch.MontoMonedero = txtmone.Text
        frmVentasTouch.Cambio = txtcambio.Text
        frmVentasTouch.Resta = txtresta.Text
        frmVentasTouch.Cliente = cboNombre.Text
    ...
    Private Sub btn100_Click(sender As System.Object, e As System.EventArgs) Handles btn100.Click
        Dim Monto As Double = txtefectivo.Text
        Dim Nuevo As Double = Monto + 100
        txtefectivo.Text = FormatNumber(Nuevo, 2)
    End Sub

    Private Sub btn200_Click(sender As System.Object, e As System.EventArgs) Handles btn200.Click
        Dim Monto As Double = txtefectivo.Text
        Dim Nuevo As Double = Monto + 200
        txtefectivo.Text = FormatNumber(Nuevo, 2)
    End Sub

    Private Sub btn500_Click(sender As System.Object, e As System.EventArgs) Handles btn500.Click
        Dim Monto As Double = txtefectivo.Text
        Dim Nuevo As Double = Monto + 500
        txtefectivo.Text = FormatNumber(Nuevo, 2)
    End Sub

    Private Sub btn1000_Click(sender As System.Object, e As System.EventArgs) Handles btn1000.Click
        Dim Monto As Double = txtefectivo.Text
    ...
    Private Sub cboNombre_SelectedValueChanged(sender As System.Object, e As System.EventArgs) Handles cboNombre.SelectedValueChanged
        ...
        If rd1.HasRows Then
            If rd1.Read Then
                ...
                frmVentasTouch.lbltipoventa.Text = MyIdCliente
        ...
        rd1.Close()
        cnn1.Close()
        If cboNombre.Text = "" Then frmVentasTouch.lbltipoventa.Text = "MOSTRADOR" : MyIdCliente = 0
        txtDireccion.Focus().Equals(True)
        Exit Sub
345:

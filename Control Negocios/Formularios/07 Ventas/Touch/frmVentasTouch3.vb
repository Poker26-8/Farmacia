...
Public Class frmVentasTouch3
    ...
    Private Sub tFecha_Tick(sender As System.Object, e As System.EventArgs) Handles tFecha.Tick
        Me.Text = "Delsscom® Control Negocios Pro  -  Ventas touch 3" & Strings.Space(40) & Date.Now
...
keseso:
    ...
    Private Sub btnpagar_Click(sender As System.Object, e As System.EventArgs) Handles btnpagar.Click
        If frmVentasTouchPago3.Visible = False Then
            frmVentasTouchPago3.Show(Me)
            frmVentasTouchPago3.txtresta.Text = FormatNumber(lblTotal.Text, 2)
            frmVentasTouchPago3.resta = FormatNumber(lblTotal.Text, 2)
        End If
    End Sub
...
kakaxd:
            ...
            If frmVentasTouchPago3.Visible = True Then
                frmVentasTouchPago3.Hide()
            End If
...
Door:
    ...
    Private Sub btnlimpiar_Click(sender As System.Object, e As System.EventArgs) Handles btnlimpiar.Click
        ...
        frmVentasTouchPago3.txtefectivo.Text = "0.00"
        frmVentasTouchPago3.txttarjeta.Text = "0.00"
        frmVentasTouchPago3.txtcambio.Text = "0.00"
        frmVentasTouchPago3.resta = 0
        frmVentasTouchPago3.txtresta.Text = "0.00"
        frmVentasTouchPago3.txtMonedero.Text = ""
        frmVentasTouchPago3.txtmone.Text = "0.00"
        frmVentasTouchPago3.cboNombre.Text = ""
        frmVentasTouchPago3.txtDireccion.Text = ""
        frmVentasTouchPago3.Label20.Visible = False
        frmVentasTouchPago3.txtcredito.Visible = False
        frmVentasTouchPago3.Label17.Visible = False
        frmVentasTouchPago3.txtafavor.Visible = False
        frmVentasTouchPago3.Label18.Visible = False
        frmVentasTouchPago3.txtadeuda.Visible = False
        frmVentasTouchPago3.txtcredito.Text = "0.00"
        frmVentasTouchPago3.txtafavor.Text = "0.00"
        frmVentasTouchPago3.txtadeuda.Text = "0.00"
        frmVentasTouchPago3.txtsaldo.Text = "0.00"
        Refresh()
        Departamentos()
        TextBox1.Text = "0"
        globaltotal = 0

...
Class frmVentasTouch2
    ...
    Private Sub tFecha_Tick(sender As System.Object, e As System.EventArgs) Handles tFecha.Tick
        Me.Text = "Delsscom® Control Negocios Pro  -  Ventas touch 2" & Strings.Space(40) & Date.Now
                ...
                If rd1.Read Then
                    ...
                    If rd2.HasRows Then
                        If rd2.Read Then
                            ...
                            Else
                                If chec = True Then
                                    IIf(Existe = rd1("Existencia").ToString = "", 0, rd1("Existencia").ToString)
            ...
            If rd3.HasRows Then
                If rd3.Read Then
                    If Tipo_Precio = "DIA_NOCHE" And (H_Actual > H_Inicia Or H_Actual < H_Final) Then
                        MyPrecio = CDbl(IIf(rd3("PreEsp").ToString = "", "0", rd3("PreEsp").ToString)) * TiCambio
...
keseso:
    ...
    Private Sub btnpagar_Click(sender As System.Object, e As System.EventArgs) Handles btnpagar.Click
        If frmVentasTouchPago2.Visible = False Then
            frmVentasTouchPago2.Show(Me)
            frmVentasTouchPago2.txtresta.Text = FormatNumber(lblTotal.Text, 2)
            frmVentasTouchPago2.resta = FormatNumber(lblTotal.Text, 2)
        End If
    End Sub
...
kakaxd:
            ...
            If frmVentasTouchPago2.Visible = True Then
                frmVentasTouchPago2.Hide()
            End If
...
Door:
    ...
    Private Sub pVenta58_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles pVenta58.PrintPage
        'Fuentes prederminadas
        Dim tipografia As String = "Lucida Sans Typewriter"
        Dim fuente_datos As New System.Drawing.Font(tipografia, 8, FontStyle.Regular)
        Dim fuente_prods As New System.Drawing.Font(tipografia, 7, FontStyle.Regular)
        Dim fuente_fecha As New System.Drawing.Font(tipografia, 6, FontStyle.Regular)
        'Variables
        Dim sc As New StringFormat With {.Alignment = StringAlignment.Center}
        Dim sf As New StringFormat With {.Alignment = StringAlignment.Far}
        Dim pen As New Pen(Brushes.Black, 1)
        ...
        Try
            ...
            If rd1.HasRows Then
                If rd1.Read Then
                    ...
                    'RFC
                    If rd1("Cab1").ToString() <> "" Then
                        e.Graphics.DrawString(rd1("Cab1").ToString, New System.Drawing.Font(tipografia, 8, FontStyle.Bold), Brushes.Black, 90, Y, sc)
                        Y += 11
                    End If
                    'Calle  N°.
                    If rd1("Cab2").ToString() <> "" Then
                        e.Graphics.DrawString(rd1("Cab2").ToString, New System.Drawing.Font(tipografia, 8, FontStyle.Regular), Brushes.Gray, 90, Y, sc)
                        Y += 10
                    End If
                    'Colonia
                    If rd1("Cab3").ToString() <> "" Then
                        e.Graphics.DrawString(rd1("Cab3").ToString, New System.Drawing.Font(tipografia, 8, FontStyle.Regular), Brushes.Gray, 90, Y, sc)
                        Y += 11
                    End If
                    'Delegación / Municipio - Entidad
                    If rd1("Cab4").ToString() <> "" Then
                        e.Graphics.DrawString(rd1("Cab4").ToString, New System.Drawing.Font(tipografia, 8, FontStyle.Regular), Brushes.Gray, 90, Y, sc)
                        Y += 11
                    End If
                    'Teléfono
                    If rd1("Cab5").ToString() <> "" Then
                        e.Graphics.DrawString(rd1("Cab5").ToString, New System.Drawing.Font(tipografia, 8, FontStyle.Regular), Brushes.Gray, 90, Y, sc)
                        Y += 11
                    End If
                    'Correo
                    If rd1("Cab6").ToString() <> "" Then
                        e.Graphics.DrawString(rd1("Cab6").ToString, New System.Drawing.Font(tipografia, 8, FontStyle.Regular), Brushes.Gray, 90, Y, sc)
                        Y += 11
                    End If
                    Y += 2
                End If
            ...
            e.Graphics.DrawString("--------------------------------------------------------", New System.Drawing.Font(tipografia, 12, FontStyle.Regular), Brushes.Black, 1, Y)
            Y += 12
            e.Graphics.DrawString("N O T A  D E  V E N T A", New System.Drawing.Font(tipografia, 8, FontStyle.Bold), Brushes.Black, 90, Y, sc)
            Y += 7
            e.Graphics.DrawString("--------------------------------------------------------", New System.Drawing.Font(tipografia, 12, FontStyle.Regular), Brushes.Black, 1, Y)
            Y += 12
            ...
            If Cliente <> "" Then
                e.Graphics.DrawString("--------------------------------------------------------", New System.Drawing.Font(tipografia, 12, FontStyle.Regular), Brushes.Black, 1, Y)
                Y += 12
                e.Graphics.DrawString("C L I E N T E", New System.Drawing.Font(tipografia, 8, FontStyle.Bold), Brushes.Black, 90, Y, sc)
                Y += 7
                e.Graphics.DrawString("--------------------------------------------------------", New System.Drawing.Font(tipografia, 12, FontStyle.Regular), Brushes.Black, 1, Y)
                Y += 15
            ...
            e.Graphics.DrawString("PRODUCTO", New System.Drawing.Font(tipografia, 6, FontStyle.Bold), Brushes.Black, 90, Y, sc)
            Y += 11
            e.Graphics.DrawString("CANTIDAD", New System.Drawing.Font(tipografia, 6, FontStyle.Bold), Brushes.Black, 1, Y)
            e.Graphics.DrawString("PRECIO U.", New System.Drawing.Font(tipografia, 6, FontStyle.Bold), Brushes.Black, 130, Y, sf)
            e.Graphics.DrawString("TOTAL", New System.Drawing.Font(tipografia, 6, FontStyle.Bold), Brushes.Black, 180, Y, sf)
            Y += 6
            e.Graphics.DrawString("--------------------------------------------------------", New System.Drawing.Font(tipografia, 12, FontStyle.Regular), Brushes.Black, 1, Y)
            Y += 15
            ...
            e.Graphics.DrawString("--------------------------------------------------------", New System.Drawing.Font(tipografia, 12, FontStyle.Regular), Brushes.Black, 1, Y)
            Y += 15
            e.Graphics.DrawString("TOTAL DE PRODUCTOS " & total_prods, New System.Drawing.Font(tipografia, 8, FontStyle.Bold), Brushes.Black, 90, Y, sc)
            Y += 7
            e.Graphics.DrawString("--------------------------------------------------------", New System.Drawing.Font(tipografia, 12, FontStyle.Regular), Brushes.Black, 1, Y)
            Y += 15
            ...
            e.Graphics.DrawString("Total:", fuente_prods, Brushes.Black, 1, Y)
            e.Graphics.DrawString(simbolo & FormatNumber(lblTotal.Text, 2), fuente_prods, Brushes.Black, 180, Y, sf)
            Y += 15
            ...
            If CDbl(MontoEfectivo) > 0 Then
                e.Graphics.DrawString("Efectivo:", fuente_prods, Brushes.Black, 1, Y)
                e.Graphics.DrawString(simbolo & FormatNumber(MontoEfectivo, 2), fuente_prods, Brushes.Black, 180, Y, sf)
                Y += 12
            End If
            If CDbl(Cambio) > 0 Then
                e.Graphics.DrawString("Cambio:", fuente_prods, Brushes.Black, 1, Y)
                e.Graphics.DrawString(simbolo & FormatNumber(Cambio, 2), fuente_prods, Brushes.Black, 180, Y, sf)
                Y += 12
            End If
            ...
            If MontoTarjeta > 0 Then
                e.Graphics.DrawString("Pago con tarjeta(s):", fuente_prods, Brushes.Black, 1, Y)
                e.Graphics.DrawString(simbolo & FormatNumber(MontoTarjeta, 2), fuente_prods, Brushes.Black, 180, Y, sf)
                Y += 12
            End If
            If MontoMonedero > 0 Then
                e.Graphics.DrawString("Pago con monedero(s):", fuente_prods, Brushes.Black, 1, Y)
                e.Graphics.DrawString(simbolo & FormatNumber(MontoMonedero, 2), fuente_prods, Brushes.Black, 180, Y, sf)
                Y += 12
            End If
            ...
            If DesglosaIVA = "1" Then
                If TotalIVAPrint > 0 Then
                    If IVA > 0 And IVA <> CDbl(lblTotal.Text) Then
                        Y += 12
                        e.Graphics.DrawString("*** IVA 16%", New System.Drawing.Font(tipografia, 8, FontStyle.Regular), Brushes.Black, 1, Y)
                        e.Graphics.DrawString(simbolo & FormatNumber(IVA, 2), New System.Drawing.Font(tipografia, 8, FontStyle.Regular), Brushes.Black, 180, Y, sf)
                        Y += 12
                    End If
                End If
                If TotalIEPS > 0 Then
                    e.Graphics.DrawString("*** IEPS 8%", New System.Drawing.Font(tipografia, 8, FontStyle.Regular), Brushes.Black, 1, Y)
                    e.Graphics.DrawString(simbolo & FormatNumber(TotalIEPS, 2), New System.Drawing.Font(tipografia, 8, FontStyle.Regular), Brushes.Black, 180, Y, sf)
                    Y += 12
                End If
            End If
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        frmVentasTouch3.Show()
        frmVentasTouch3.BringToFront()
    End Sub

    Private Sub frmVentasTouch2_Activated(sender As Object, e As EventArgs) Handles MyBase.Activated
        txtbarras.Focus.Equals(True)
    End Sub
    ...
    Private Sub btnlimpiar_Click(sender As System.Object, e As System.EventArgs) Handles btnlimpiar.Click
        ...
        frmVentasTouchPago2.txtefectivo.Text = "0.00"
        frmVentasTouchPago2.txttarjeta.Text = "0.00"
        frmVentasTouchPago2.txtcambio.Text = "0.00"
        frmVentasTouchPago2.resta = 0
        frmVentasTouchPago2.txtresta.Text = "0.00"
        frmVentasTouchPago2.txtMonedero.Text = ""
        frmVentasTouchPago2.txtmone.Text = "0.00"
        frmVentasTouchPago2.cboNombre.Text = ""
        frmVentasTouchPago2.txtDireccion.Text = ""
        frmVentasTouchPago2.Label20.Visible = False
        frmVentasTouchPago2.txtcredito.Visible = False
        frmVentasTouchPago2.Label17.Visible = False
        frmVentasTouchPago2.txtafavor.Visible = False
        frmVentasTouchPago2.Label18.Visible = False
        frmVentasTouchPago2.txtadeuda.Visible = False
        frmVentasTouchPago2.txtcredito.Text = "0.00"
        frmVentasTouchPago2.txtafavor.Text = "0.00"
        frmVentasTouchPago2.txtadeuda.Text = "0.00"
        frmVentasTouchPago2.txtsaldo.Text = "0.00"
        Refresh()
        Departamentos()
        TextBox1.Text = "0"
        globaltotal = 0

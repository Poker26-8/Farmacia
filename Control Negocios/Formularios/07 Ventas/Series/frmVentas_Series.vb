    ...
    Private Sub cbodesc_KeyPress(sender As Object, e As KeyPressEventArgs) Handles cbodesc.KeyPress
        ...
        If AscW(e.KeyChar) = Keys.Enter Then
            ...
            Try
                ...
                Else
                    rd1.Close()
                    cmd1.CommandText = "SELECT * FROM Productos WHERE CodBarra1='" & cbodesc.Text & "'"
                    rd1 = cmd1.ExecuteReader
                    If rd1.HasRows Then
                    Else
                        rd1.Close()
                        cmd1.CommandText = "SELECT * FROM Productos WHERE CodBarra2='" & cbodesc.Text & "'"
                        rd1 = cmd1.ExecuteReader
                        If rd1.HasRows Then
                        Else
                            cmd1.CommandText = "SELECT * FROM Productos WHERE CodBarra3='" & cbodesc.Text & "'"
                        End If
                    End If
        ...
        With oData
            If .dbOpen(a_cnn, Direcc_Access, sInfo) Then
                ...
                If cboNombre.Text <> "" Then
                    cnn3.Close() : cnn3.Open()
                    cmd3 = cnn3.CreateCommand
                    cmd3.CommandText = "SELECT * FROM Clientes WHERE Nombre='" & cboNombre.Text & "'"
                    rd3 = cmd3.ExecuteReader
                    If rd3.HasRows Then
                        If rd3.Read Then
                            tel_cliente = rd3("Telefono").ToString()

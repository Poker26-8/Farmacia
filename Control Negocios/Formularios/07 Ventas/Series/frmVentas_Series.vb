...
#Region "Funciones"
    Public Sub Folio()
        Try
            ...
            If Me.Text = "Pedidos Series" Then
                cmd9.CommandText =
                    "select MAX(Folio) from CotPed"
            End If
...
doorcita:
        ...
        If AscW(e.KeyChar) = Keys.Enter Then
            If franquicia = 0 Then
                Try
                    ...
                    cmd1 = cnn1.CreateCommand
                    cmd1.CommandText =
                        "select Suspender,Tipo,Id,Credito,Comisionista,SaldoFavor from Clientes where Nombre='" & cboNombre.Text & "'"
                    rd1 = cmd1.ExecuteReader
                    If rd1.HasRows Then
                        If rd1.Read Then
    ...
    Private Sub cboNombre_SelectedValueChanged(sender As Object, e As EventArgs) Handles cboNombre.SelectedValueChanged
        ...
        If franquicia = 0 Then
            Try
                ...
                cmd1 = cnn1.CreateCommand
                cmd1.CommandText =
                    "select Suspender,Tipo,Id,Credito,Comisionista,Telefono,Calle,NInterior,NExterior,Colonia,Delegacion,Entidad,Pai,CP,SaldoFavor from Clientes where Nombre='" & cboNombre.Text & "'"
                rd1 = cmd1.ExecuteReader
                If rd1.HasRows Then
                    If rd1.Read Then
                        If (rd1("Suspender").ToString) Then MsgBox("Venta suspendida a este cliente." & vbNewLine & "Consulta con el administrador.", vbInformation + vbOKOnly, "Delsscom Control Negocios Pro") : rd1.Close() : cnn1.Close() : Exit Sub
    ...
    Private Sub cbocomisionista_DropDown(sender As Object, e As EventArgs)
    ...
    Private Sub cbocomisionista_KeyPress(sender As Object, e As KeyPressEventArgs)
        e.KeyChar = UCase(e.KeyChar)
        If AscW(e.KeyChar) = Keys.Enter Then
            btnventa.Focus().Equals(True)
        End If
    ...
    Private Sub cbodesc_KeyDown(sender As Object, e As KeyEventArgs) Handles cbodesc.KeyDown
        Select Case e.KeyCode
            Case Is = Keys.F2
                ...
                End If
            Case Is = Keys.F3
                frmBuscaVentas.Vienna = "Ventas Series"
                frmBuscaVentas.Show()
            Case Is = Keys.F5
                frmVentasKit.Vienna = "Ventas Series"
                frmVentasKit.Show()
            Case Is = Keys.F7
    ...
    Private Sub cbodesc_KeyPress(sender As Object, e As KeyPressEventArgs) Handles cbodesc.KeyPress
        ...
        If AscW(e.KeyChar) = Keys.Enter Then
            ...
            Try
                ...
                cmd1 = cnn1.CreateCommand
                cmd1.CommandText = "SELECT Status_Promocion,Grupo,Departamento,Codigo,Nombre,UVenta,Multiplo,Min,Ubicacion FROM Productos WHERE CodBarra='" & cbodesc.Text & "'"
                rd1 = cmd1.ExecuteReader
                If rd1.HasRows Then
                Else
                    rd1.Close()
                    cmd1.CommandText = "SELECT Status_Promocion,Grupo,Departamento,Codigo,Nombre,UVenta,Multiplo,Min,Ubicacion FROM Productos WHERE CodBarra1='" & cbodesc.Text & "'"
                    rd1 = cmd1.ExecuteReader
                    If rd1.HasRows Then
                    Else
                        rd1.Close()
                        cmd1.CommandText = "SELECT Status_Promocion,Grupo,Departamento,Codigo,Nombre,UVenta,Multiplo,Min,Ubicacion FROM Productos WHERE CodBarra2='" & cbodesc.Text & "'"
                        rd1 = cmd1.ExecuteReader
                        If rd1.HasRows Then
                        Else
                            cmd1.CommandText = "SELECT Status_Promocion,Grupo,Departamento,Codigo,Nombre,UVenta,Multiplo,Min,Ubicacion FROM Productos WHERE CodBarra3='" & cbodesc.Text & "'"
                        End If
                    End If
        ...
        If AscW(e.KeyChar) = Keys.Enter And (cbocodigo.Text <> "" Or cbodesc.Text <> "") Then
            ...
            If cbocodigo.Text <> "" Then
                Try
                    ...
                    cmd1 = cnn1.CreateCommand
                    cmd1.CommandText =
                        "select Status_Promocion,Grupo,Departamento,Nombre,PrecioVentaIVA,UVenta,Codigo,Nombre,MCD,Multiplo,Min,Ubicacion from Productos where Codigo='" & cbocodigo.Text & "'"
                    rd1 = cmd1.ExecuteReader
                    If rd1.HasRows Then
                        If rd1.Read Then
                ...
                If rd1.Read Then
                    If CStr(rd1(0).ToString) = "SERVICIOS" Then
                        ...
                        If AscW(e.KeyChar) = Keys.Enter Then
                            ...
                            cmd2 = cnn2.CreateCommand
                            cmd2.CommandText =
                                "select Codigo  from series where Codigo='" & cbocodigo.Text & "'"
                            rd2 = cmd2.ExecuteReader
                            If rd2.HasRows Then
    ...
    Private Sub cboSerie_DropDown(sender As Object, e As EventArgs) Handles cboSerie.DropDown
        ...
        If btndevo.Text = "GUARDAR DEVOLUCIÓN" Then
            cmd1.CommandText =
                "SELECT serie FROM series WHERE Codigo='" & cbocodigo.Text & "'"
            rd1 = cmd1.ExecuteReader
            Do While rd1.Read
    ...
    Private Sub cboSerie_KeyPress(sender As Object, e As KeyPressEventArgs) Handles cboSerie.KeyPress
        ...
        If AscW(e.KeyChar) = Keys.Enter Then
            ...
            cmd1 = cnn1.CreateCommand
            cmd1.CommandText = "SELECT Departamento,Grupo FROM Productos WHERE Codigo='" & cbocodigo.Text & "'"
            rd1 = cmd1.ExecuteReader
            If rd1.HasRows Then
                If rd1.Read Then
                    If CStr(rd1("Departamento").ToString()) = "SERVICIOS" Then
    ...
    Private Sub cbotpago_DropDown(sender As Object, e As EventArgs) Handles cbotpago.DropDown
        ...
        Try
            ...
            cmd1 = cnn1.CreateCommand
            cmd1.CommandText = "select distinct FormaPago from FormasPago where FormaPago<>''"
            rd1 = cmd1.ExecuteReader
            Do While rd1.Read
...
doorcita:
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        If Me.Text = "Ventas Series" Then
            ...
            cboNombre.Focus().Equals(True)
        ElseIf Me.Text = "Cotización Series" Then
...
Door:
    ...
    Private Sub Valida_Datos_Cliente(ByVal nombre As String)
        Try
            ...
            For valida_cli As Integer = 1 To 6
                cmd4 = cnn4.CreateCommand
                cmd4.CommandText =
                    "select Suspender,Tipo,Id,Credito,Comisionista,Telefono,SaldoFavor from Clientes where Nombre='" & nombre & "'"
                rd4 = cmd4.ExecuteReader
                If rd4.HasRows Then
                    If rd4.Read Then
    ...
    Private Sub btnventa_Click(sender As Object, e As EventArgs) Handles btnventa.Click
                    ...
                    If rd1.HasRows Then
                        If rd1.Read Then
                            If rd1(0).ToString > 0 Then
                                subb = grdcaptura.Rows(N).Cells(5).Value.ToString
                                ivapro = subb / (1 + rd1(0).ToString)
                                ivaproducto = subb - CDbl(ivapro)
        ...
        If totalcomision > 0 Then
            If cbocomisionista.Text = "" Then MsgBox("Seleccione al comisionista de la venta", vbInformation + vbOKOnly, titulocentral) : cbocomisionista.Focus.Equals(True) : Exit Sub
...
kakaxd:
            ...
            Select Case lblNumCliente.Text
                Case Is = "MOSTRADOR"
                    ...
                    If CDbl(txtdescuento1.Text) > 0 Then
                        ...
                        cmd1 = cnn1.CreateCommand
                        cmd1.CommandText =
                            "insert into Ventas(IdCliente,Cliente,Direccion,Subtotal,IVA,Totales,Descuento,Devolucion,ACuenta,Resta,Usuario,FVenta,HVenta,FPago,FCancelado,Status,Comisionista,Comision,Concepto,MontoSinDesc,FEntrega,Entrega,Comentario,StatusE,FolMonedero,CodFactura,IP,Formato,Franquicia,Fecha) values(" & IdCliente & ",'" & IIf(cboNombre.Text = "", "PUBLICO EN GENERAL", cboNombre.Text) & "','" & txtdireccion.Text & "'," & SubTotal & "," & TotalIVAPrint & "," & Total_Ve & "," & Descuento & ",0," & ACuenta & "," & Resta & ",'" & lblusuario.Text & "','" & Format(Date.Now, "yyyy-MM-dd") & "','" & Format(Date.Now, "HH:mm:ss") & "','" & fecha_pago & "','','" & MyStatus & "','" & cbocomisionista.Text & "'," & totalcomision & ",''," & MontoSDesc & ",'" & Format(dtpFecha_E.Value, "dd/MM/yyyy") & "',0,'',0,'" & txtMonedero.Text & "','" & CodCadena & "','" & dameIP2() & "','" & cboimpresion.Text & "', " & validafranquicia & ",'" & Format(Date.Now, "yyyy-MM-dd HH:mm:ss") & "')"
                        cmd1.ExecuteNonQuery()
                        cnn1.Close()
                    Else
                        IVA_Vent = FormatNumber(CDbl(txtPagar.Text) - CDbl(TotalIVAPrint), 2)
                        ...
                        cmd1 = cnn1.CreateCommand
                        cmd1.CommandText =
                            "insert into Ventas(IdCliente,Cliente,Direccion,Subtotal,IVA,Totales,Descuento,Devolucion,ACuenta,Resta,Usuario,FVenta,HVenta,FPago,FCancelado,Status,Comisionista,Comision,Concepto,MontoSinDesc,FEntrega,Entrega,Comentario,StatusE,FolMonedero,CodFactura,IP,Formato,Franquicia,Fecha) values(" & IdCliente & ",'" & IIf(cboNombre.Text = "", "PUBLICO EN GENERAL", cboNombre.Text) & "','" & txtdireccion.Text & "'," & IVA_Vent & "," & SubTotal & "," & Total_Ve & "," & Descuento & ",0," & ACuenta & "," & Resta & ",'" & lblusuario.Text & "','" & Format(Date.Now, "yyyy-MM-dd") & "','" & Format(Date.Now, "HH:mm:ss") & "','" & fecha_pago & "','','" & MyStatus & "','" & cbocomisionista.Text & "'," & totalcomision & ",''," & MontoSDesc & ",'" & Format(dtpFecha_E.Value, "dd/MM/yyyy") & "',0,'',0,'" & txtMonedero.Text & "','" & CodCadena & "','" & dameIP2() & "','" & cboimpresion.Text & "'," & validafranquicia & ",'" & Format(Date.Now, "yyyy-MM-dd HH:mm:ss") & "')"
                        cmd1.ExecuteNonQuery()
                        cnn1.Close()
                    End If
                Case Is <> "MOSTRADOR"
                    ...
                    cmd1 = cnn1.CreateCommand
                    cmd1.CommandText =
                        "insert into Ventas(IdCliente,Cliente,Direccion,Subtotal,IVA,Totales,Descuento,Devolucion,ACuenta,Resta,Usuario,FVenta,HVenta,FPago,FCancelado,Status,Comisionista,Comision,Concepto,MontoSinDesc,FEntrega,Entrega,Comentario,StatusE,FolMonedero,CodFactura,IP,Formato,Franquicia,Fecha) values(" & IdCliente & ",'" & IIf(cboNombre.Text = "", "PUBLICO EN GENERAL", cboNombre.Text) & "','" & txtdireccion.Text & "'," & IVA_Vent & "," & SubTotal & "," & Total_Ve & "," & Descuento & ",0," & ACUenta2 & "," & Resta & ",'" & lblusuario.Text & "','" & Format(Date.Now, "yyyy-MM-dd") & "','" & Format(Date.Now, "HH:mm:ss") & "','" & fecha_pago & "','','" & MyStatus & "','" & cbocomisionista.Text & "'," & totalcomision & ",''," & MontoSDesc & ",'" & Format(dtpFecha_E.Value, "dd/MM/yyyy") & "',0,'',0,'" & txtMonedero.Text & "','" & CodCadena & "','" & dameIP2() & "','" & cboimpresion.Text & "'," & validafranquicia & ",'" & Format(Date.Now, "yyyy-MM-dd HH:mm:ss") & "')"
                    cmd1.ExecuteNonQuery()
                    cnn1.Close()
            End Select
        ...
        Try
            If txttel.Text <> "" Then
                ...
                cnn1.Close() : cnn1.Open()
                cmd1 = cnn1.CreateCommand
                cmd1.CommandText = "select NumPart,NotasCred from Formatos where Facturas='Porc_Mone'"
                rd1 = cmd1.ExecuteReader
                If rd1.HasRows Then
                    If rd1.Read Then
                ...
                If tipo_mone = 1 Then
                    ...
                    Dim total_abonoo As Double = (porcentaje_mone * total_venta) / 100
                ...
                If grdpago.Rows.Count > 0 Then
                    ...
                    For R As Integer = 0 To grdpago.Rows.Count - 1
                        ...
                        If CStr(grdpago.Rows(R).Cells(0).Value.ToString()) = FormaPago Then
                            ...
                            BancoFP = grdpago.Rows(R).Cells(1).Value.ToString()
                        ...
                        If TotFormaPago > 0 Then
                            ...
                            cmd2 = cnn2.CreateCommand
                            cmd2.CommandText =
                                "insert into AbonoI(NumFolio,IdCliente,Cliente,Concepto,Fecha,Hora,FechaCompleta,Cargo,Abono,Saldo,FormaPago,Monto,Banco,Referencia,Usuario,Comentario,Comisiones) values(" & MYFOLIO & "," & IdCliente & ",'" & IIf(cboNombre.Text = "", "PUBLICO EN GENERAL", cboNombre.Text) & "','ABONO','" & Format(Date.Now, "yyyy-MM-dd") & "','" & Format(Date.Now, "HH:mm:ss") & "','" & Format(Date.Now, "yyyy-MM-dd HH:mm:ss") & "',0," & TotFormaPago & "," & (MySaldo) & ",'" & FormaPago & "'," & TotFormaPago & ",'" & BancoFP & "','" & ReferenciaFP & "','" & lblusuario.Text & "','" & CmentarioFP & "'," & totalcomision & ")"
                            cmd2.ExecuteNonQuery()
                            cnn2.Close()
                            ...
                            If EfectivoX > 0 Then
                                cnn2.Close() : cnn2.Open()
                                cmd2 = cnn2.CreateCommand
                                cmd2.CommandText = "SELECT NumFolio FROM abonoi WHERE NumFolio=" & MYFOLIO
                                rd2 = cmd2.ExecuteReader
                                If rd2.HasRows Then
                                    If rd2.Read Then
                                        cnn3.Close() : cnn3.Open()
                                        cmd3 = cnn3.CreateCommand
                                        cmd3.CommandText = "UPDATE abonoi SET Comisiones=0 WHERE NumFolio=" & MYFOLIO & " AND FormaPago<>'EFECTIVO'"
                                        cmd3.ExecuteNonQuery()
                                        cnn3.Close()
                                    End If
                                End If
        ...
        If TotSaldo > 0 Then
            ...
            Try
                ...
                cmd1 = cnn1.CreateCommand
                cmd1.CommandText = "UPDATE Clientes SET SaldoFavor=" & nuevo_saldo & " WHERE Nombre='" & cboNombre.Text & "'"
                cmd1.ExecuteNonQuery()
                cnn1.Close()
            Catch ex As Exception
                MessageBox.Show(ex.ToString())
        ...
        Try
            ...
            For R As Integer = 0 To grdcaptura.Rows.Count - 1
                ...
                cmd1 = cnn1.CreateCommand
                cmd1.CommandText = "SELECT IVA FROM Productos WHERE Codigo='" & mycode & "'"
                rd1 = cmd1.ExecuteReader
                If rd1.HasRows Then
                    If rd1.Read Then
                        MyIVA = rd1(0).ToString
                ...
                cmd1 = cnn1.CreateCommand
                cmd1.CommandText = "SELECT Departamento,Grupo,ProvRes,MCD,Multiplo,Unico,GPrint FROM Productos WHERE Codigo='" & mycode & "'"
                rd1 = cmd1.ExecuteReader
                If rd1.HasRows Then
                    If rd1.Read Then
                        MyCostVUE = 0
                ...
                cmd1 = cnn1.CreateCommand
                cmd1.CommandText = "SELECT Existencia,MCD,Departamento,PrecioCompra FROM Productos WHERE Codigo='" & Strings.Left(mycode, 6) & "'"
                rd1 = cmd1.ExecuteReader
                If rd1.HasRows Then
                    If rd1.Read Then
...
Door:
                If grdcaptura.Rows(R).Cells(0).Value.ToString() <> "" Then
                    cmd1 = cnn1.CreateCommand
                    cmd1.CommandText =
                        "insert into VentasDetalle(Folio,Codigo,Nombre,Unidad,Cantidad,CostoVP,CostoVUE,Precio,Total,PrecioSinIVA,TotalSinIVA,Fecha,Comisionista,Facturado,Depto,Grupo,CostVR,Descto,VDCosteo,TotalIEPS,TasaIEPS,Caducidad,Lote,CantidadE,Promo_Monedero,Unico,Descuento,Gprint,N_Serie,FechaCompleta) values(" & MYFOLIO & ",'" & mycode & "','" & mydesc & "','" & myunid & "'," & mycant & "," & MyProm & "," & MyCostVUE & "," & myprecio & "," & mytotal & "," & myprecioS & "," & mytotalS & ",'" & Format(Date.Now, "yyyy-MM-dd") & "','" & cbocomisionista.Text & "','0','" & MyDepto & "','" & MyGrupo & "','0'," & DsctoProdTod & ",0," & ieps & "," & tasaieps & ",'','',0," & monedero & "," & IIf(Unico = False, 0, 1) & "," & DsctoProdTod & ",'" & gprint & "','" & serie & "','" & Format(Date.Now, "yyyy-MM-dd HH:mm:ss") & "')"
                    cmd1.ExecuteNonQuery()
    ...
    Private Sub pVentaCarta_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles pVentaCarta.PrintPage
        ...
        Try
            ...
            cmd1 = cnn1.CreateCommand
            cmd1.CommandText =
                "select Pie3,Cab0,Cab1,Cab2,Cab3,Cab4,Cab5,Cab6,Pagare from Ticket"
            rd1 = cmd1.ExecuteReader
            If rd1.HasRows Then
                If rd1.Read Then
                    Pie = rd1("Pie3").ToString
                    ...
                    If rd1.HasRows Then
                        If rd1.Read Then
                            If rd1(0).ToString > 0 Then
                                MySubtotal = grdcaptura.Rows(N).Cells(5).Value.ToString
                                ivaproducto = MySubtotal / (1 + rd1(0).ToString)
                                ivadeproducto = MySubtotal - ivaproducto
                                TotalIVAPrint = TotalIVAPrint + CDbl(ivadeproducto)
                            End If
                            'If CDbl(grdcaptura.Rows(N).Cells(11).Value.ToString) <> 0 Then
                            '    MySubtotal = MySubtotal + (CDbl(grdcaptura.Rows(N).Cells(11).Value.ToString) - (CDbl(grdcaptura.Rows(N).Cells(10).Value.ToString) * (CDbl(txtdescuento1.Text) / 100)))
                ...
                If TotalCantBase >= 1 And TotalCantidadProd >= 1 Then
                    ...
                    ElseIf TotalCantBase = CANTx Then
                        ...
                        Else
                            ...
                            cmd2 = cnn2.CreateCommand
                            cmd2.CommandText =
                                "select Folio from VentasDetalle where Folio=" & cbonota.Text & " and Codigo='" & CODx & "' and Total=" & Totalx & ""
                            rd2 = cmd2.ExecuteReader
                            If rd2.HasRows Then
                                If rd2.Read Then
                                    cnn3.Close() : cnn3.Open()
...
ecomoda:
                ...
                If MyDepto <> "SERVICIOS" Then
                    ...
                    If rd1.HasRows Then
                        ...
                        Do While rd1.Read
                            cmd2 = cnn2.CreateCommand
                            cmd2.CommandText =
                                "select Codigo,Existencia from Productos where Codigo='" & Strings.Left(rd1("Codigo").ToString(), 6) & "'"
                            rd2 = cmd2.ExecuteReader
                            If rd2.HasRows Then
                                If rd2.Read Then
    ...
    Private Sub Button14_Click(sender As Object, e As EventArgs) Handles Button14.Click
        Try
            ...
            ElseIf Me.Text = "Pedidos Series" Then
                ...
                For monkey As Integer = 0 To grdcaptura.Rows.Count - 1
                    ...
                    cmd1 = cnn1.CreateCommand
                    cmd1.CommandText = "SELECT IVA,Departamento,Grupo,MCD FROM productos WHERE Codigo='" & MyCodigo & "'"
                    rd1 = cmd1.ExecuteReader
                    If rd1.HasRows Then
                        If rd1.Read Then
                            MyIVA = rd1("IVA").ToString
...
doorcita:
    ...
    Private Sub txtprecio_KeyDown(sender As Object, e As KeyEventArgs) Handles txtprecio.KeyDown
        Select Case e.KeyCode
            Case Is = Keys.F3
                frmBuscarPrecio.pantalla = "Ventas Series"
                frmBuscarPrecio.codigop = cbocodigo.Text
                frmBuscarPrecio.nombrep = cbodesc.Text
                frmBuscarPrecio.Show()

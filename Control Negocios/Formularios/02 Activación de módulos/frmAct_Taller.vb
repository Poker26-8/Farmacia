Public Class frmAct_Taller
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If MsgBox("¿Deseas activar el módulo de telefonia?", vbInformation + vbOKOnly, titulocentral) = vbOK Then
            ...
            If txtcontra.Text = "jipl2211*" Then
                Try
                    ...
                    cmd1 = cnn1.CreateCommand
                    cmd1.CommandText =
                        "update Formatos set NotasCred='" & FormatDateTime(Date.Now, DateFormat.ShortDate) & "', NumPart=1 where Facturas='Taller'"
                    If cmd1.ExecuteNonQuery Then
                        MsgBox("El sistema de telefonia ha sido activado de manera correcta." & vbNewLine & "El sistema se cerrará para completar el proceso.", vbInformation + vbOKOnly, titulocentral)
                        End
                    End If
        ...
        If MsgBox("¿Deseas desactivar el módulo de telefonia?", vbInformation + vbOKOnly, "Delsscom Control Negocios Pro") = vbOK Then
            ...
            If txtcontra.Text = "jipl2211*" Then
                Try
                    ...
                    cmd1 = cnn1.CreateCommand
                    cmd1.CommandText =
                        "update Formatos set NotasCred='0', NumPart=0 where Facturas='Taller'"
                    If cmd1.ExecuteNonQuery Then
                        MsgBox("El sistema de telefonia ha sido desactivado de manera correcta." & vbNewLine & "El sistema se cerrará para completar el proceso.", vbInformation + vbOKOnly, titulocentral)
                        End
                    End If

        ...
        If MsgBox("¿Deseas activar el módulo de entregas?", vbInformation + vbOKOnly, "Delsscom Control Negocios Pro") = vbOK Then
            ...
            If txtcontra.Text = "jipl2211*" Then
                Try
                    ...
                    cmd1.CommandText =
                        "update Formatos set NotasCred='" & FormatDateTime(Date.Now, DateFormat.ShortDate) & "', NumPart=1 where Facturas='Entregas'"
                    If cmd1.ExecuteNonQuery Then
                        MsgBox("El módulo de entregas ha sido activado de manera correcta." & vbNewLine & "El sistema se cerrará para completar el proceso.", vbInformation + vbOKOnly, "Delsscom Control Negocios Pro")
                        End
                    End If
        ...
        If MsgBox("¿Deseas desactivar el módulo de entregas?", vbInformation + vbOKOnly, "Delsscom Control Negocios Pro") = vbOK Then
            ...
            If txtcontra.Text = "jipl2211*" Then
                Try
                    ...
                    cmd1 = cnn1.CreateCommand
                    cmd1.CommandText = "UPDATE Formatos SET NotasCred='0',NumPart=0 WHERE Facturas='Entregas'"
                    If cmd1.ExecuteNonQuery Then
                        MsgBox("El sistema de entregas ha sido desactivado de manera correcta." & vbNewLine & "El sistema se cerrará para completar el proceso.", vbInformation + vbOKOnly, titulomensajes)
                        End
                    End If

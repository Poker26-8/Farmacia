...
Partial Class frmModulos
    ...
    Private Sub InitializeComponent()
        ...
        Me.btnMedicas.Location = New System.Drawing.Point(899, 229)
        ...
        Me.Controls.Add(Me.btnConsignacion)
        Me.Controls.Add(Me.Label22)
        Me.Controls.Add(Me.btnFarmacia)
        Me.Controls.Add(Me.Label21)
        Me.Controls.Add(Me.btnMedicas)
        Me.Controls.Add(Me.Label20)
        Me.Controls.Add(Me.btnMensajeria)
        Me.Controls.Add(Me.Label19)
        Me.Controls.Add(Me.btnTaller)
        Me.Controls.Add(Me.Label18)
        Me.Controls.Add(Me.btnPollo)
        Me.Controls.Add(Me.Label17)
        Me.Controls.Add(Me.btnNomina)
        Me.Controls.Add(Me.Label16)
        Me.Controls.Add(Me.btnTelefonia)
        Me.Controls.Add(Me.Label15)
        Me.Controls.Add(Me.btnEscolar)
        Me.Controls.Add(Me.Label14)
        Me.Controls.Add(Me.btnTransportistas)
        Me.Controls.Add(Me.Label13)
        Me.Controls.Add(Me.btnSincronizador)
        Me.Controls.Add(Me.Label12)
        Me.Controls.Add(Me.btnZapateria)
        ...
        Me.Controls.Add(Me.btnRefaccionaria)
        Me.Controls.Add(Me.Label7)
        Me.Controls.Add(Me.btnRestaurante)
        Me.Controls.Add(Me.Label6)
        Me.Controls.Add(Me.btnProduccion)
    ...
    Friend WithEvents btnProduccion As Button
    ...
    Friend WithEvents btnZapateria As Button
    Friend WithEvents Label12 As Label
    Friend WithEvents btnSincronizador As Button
    Friend WithEvents Label13 As Label
    Friend WithEvents btnTransportistas As Button
    Friend WithEvents Label14 As Label
    Friend WithEvents btnEscolar As Button
    ...
    Friend WithEvents btnMedicas As Button
    Friend WithEvents Label21 As Label
    Friend WithEvents btnFarmacia As Button
    Friend WithEvents Label22 As Label
    Friend WithEvents btnConsignacion As Button

Public Class frmAct_Zapaterias
    Private Sub frmAct_Zapaterias_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            cmd1.CommandText = "SELECT NumPart FROM formatos WHERE Facturas='Papos'"
    ...
    Private Sub btnDesactivar_Click(sender As Object, e As EventArgs) Handles btnDesactivar.Click
        If MsgBox("¿Deseas desactivar el módulo de zapaterías?", vbInformation + vbOKOnly, "Delsscom Control Negocios Pro") = vbOK Then
            ...
            If txtcontra.Text = "jipl2211*" Then
                Try
                    ...
                    cmd1 = cnn1.CreateCommand
                    cmd1.CommandText = "UPDATE Formatos SET NotasCred='0',NumPart=0 WHERE Facturas='Papos'"
                    If cmd1.ExecuteNonQuery Then
                        MsgBox("El sistema de zapaterías ha sido desactivado de manera correcta." & vbNewLine & "El sistema se cerrará para completar el proceso.", vbInformation + vbOKOnly, titulomensajes)
                        End
                    End If

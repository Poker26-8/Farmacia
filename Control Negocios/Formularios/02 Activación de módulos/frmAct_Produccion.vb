Public Class frmAct_Produccion
        ...
        If MsgBox("¿Deseas activar el módulo de produccion?", vbInformation + vbOKOnly, "Delsscom Control Negocios Pro") = vbOK Then
            ...
            If txtcontra.Text = "jipl2211*" Then
                Try
                    ...
                    cmd1.CommandText =
                        "update Formatos set NotasCred='" & FormatDateTime(Date.Now, DateFormat.ShortDate) & "', NumPart=1 where Facturas='Produccion'"
    ...
    Private Sub frmAct_Produccion_Load(sender As Object, e As EventArgs) Handles MyBase.Load

Public Class frmBuscaCompras
    ...
    Private Sub optcoincide_Click(sender As System.Object, e As System.EventArgs) Handles optcoincide.Click
    ...
    Private Sub RadioButton1_Click(sender As System.Object, e As System.EventArgs) Handles optsalidas.Click
    ...
    Private Sub grdcaptura_CellDoubleClick(sender As System.Object, e As System.Windows.Forms.DataGridViewCellEventArgs) Handles grdcaptura.CellDoubleClick
        If grdcaptura.Rows.Count > 0 Then
            ...
            frmCompras.txtcodigo.Text = grdcaptura.Rows(index).Cells(0).Value.ToString
            frmCompras.cbonombre.Text = grdcaptura.Rows(index).Cells(1).Value.ToString
            frmCompras.txtunidad.Text = grdcaptura.Rows(index).Cells(2).Value.ToString
            frmCompras.txtprecio.Text = FormatNumber(grdcaptura.Rows(index).Cells(3).Value.ToString, 2)
            frmCompras.txtexiste.Text = grdcaptura.Rows(index).Cells(4).Value.ToString

            Me.Close()
            frmCompras.txtcodigo.Focus().Equals(True)
        End If
    End Sub
    ...
    Private Sub frmBuscaCompras_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        optproveedor.PerformClick()
    End Sub

    Private Sub optsalidas_CheckedChanged(sender As System.Object, e As System.EventArgs) Handles optsalidas.CheckedChanged
        If (optsalidas.Checked) Then
            grdcaptura.ColumnCount = 0
            grdcaptura.Rows.Clear()
            grdcaptura.ColumnCount = 8

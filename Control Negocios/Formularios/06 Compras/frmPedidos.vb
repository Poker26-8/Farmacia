...
Public Class frmPedidos
    ...
    Private Sub cboprov_DropDown(sender As System.Object, e As System.EventArgs) Handles cboprov.DropDown
        cboprov.Items.Clear()
        Try
    ...
    Private Sub cboprov_SelectedValueChanged(sender As System.Object, e As System.EventArgs) Handles cboprov.SelectedValueChanged
        Try
            cnn1.Close() : cnn1.Open()
    ...
    Private Sub cboprov_KeyPress(sender As System.Object, e As System.Windows.Forms.KeyPressEventArgs) Handles cboprov.KeyPress
    ...
    Private Sub cbopedido_DropDown(sender As System.Object, e As System.EventArgs) Handles cbopedido.DropDown
    ...
    Private Sub cbopedido_SelectedValueChanged(sender As System.Object, e As System.EventArgs) Handles cbopedido.SelectedValueChanged
        Try
            cnn1.Close() : cnn1.Open()
...
caca:
    ...
    Private Sub txtref_Click(sender As System.Object, e As System.EventArgs) Handles txtref.Click
        txtref.SelectionStart = 0
        txtref.SelectionLength = Len(txtref.Text)
    End Sub

    Private Sub txtref_GotFocus(sender As Object, e As System.EventArgs) Handles txtref.GotFocus
        txtref.SelectionStart = 0
        txtref.SelectionLength = Len(txtref.Text)
    End Sub

    Private Sub txtref_KeyPress(sender As System.Object, e As System.Windows.Forms.KeyPressEventArgs) Handles txtref.KeyPress
        If AscW(e.KeyChar) = Keys.Enter Then
            If cboTpago.Text = "" Then
    ...
    Private Sub cboTpago_TextChanged(sender As System.Object, e As System.EventArgs) Handles cboTpago.TextChanged
        If cboTpago.Text = "EFECTIVO" Then
            cboBanco.Enabled = False
            txtref.Enabled = False
        Else

...
Public Class frmLoad
    ...
    Public Sub verif()
        ...
        Catch ex As Exception
            rd1.Close()
            cmd1 = cnn1.CreateCommand
            cmd1.CommandText = "ALTER TABLE VentasDetalle add column CodUnico varchar(255) DEFAULT ''"
            cmd1.ExecuteNonQuery()
            cnn1.Close()
        End Try
        ...
        Catch ex As Exception
            rd1.Close()
            cmd1 = cnn1.CreateCommand
            cmd1.CommandText = "ALTER TABLE BeneficiosFanasa add column Cantidad double NOT NULL DEFAULT '0'"
            cmd1.ExecuteNonQuery()
            cnn1.Close()
        End Try
        ...
        Try
            ...
            cnn1.Open()
            cmd1 = cnn1.CreateCommand
            cmd1.CommandText = "SELECT IdNube FROM cardex"
            rd1 = cmd1.ExecuteReader
            If rd1.Read Then
            End If
            rd1.Close()
        ...
        Catch ex As Exception
            rd1.Close()
            cmd1 = cnn1.CreateCommand
            cmd1.CommandText = "ALTER TABLE cardex add column IdNube INT DEFAULT '0'"
            cmd1.ExecuteNonQuery()
            cnn1.Close()
        End Try
        ...
        Try
            ...
            cnn1.Open()
            cmd1 = cnn1.CreateCommand
            cmd1.CommandText = "SELECT IdNube FROM trasladosdet"
            rd1 = cmd1.ExecuteReader
            If rd1.Read Then
            End If
            rd1.Close()
        ...
        Catch ex As Exception
            rd1.Close()
            cmd1 = cnn1.CreateCommand
            cmd1.CommandText = "ALTER TABLE trasladosdet add column IdNube INT DEFAULT '0'"
            cmd1.ExecuteNonQuery()
            cnn1.Close()
        End Try

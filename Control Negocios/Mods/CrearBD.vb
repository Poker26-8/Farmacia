...
"
    ...
    Public vartabladdetalle_factura As String = "CREATE TABLE IF NOT EXISTS `detalle_factura` (
                                              ...
                                              `unidad` varchar(50) NOT NULL DEFAULT '',
                                              `cantidad` float NOT NULL DEFAULT '0',
                                              `preciou` float NOT NULL DEFAULT '0',
                                              `totaliva` float NOT NULL DEFAULT '0',
                                              `porceniva` float NOT NULL DEFAULT '0',
                                              `descuento` float NOT NULL DEFAULT '0',
    ...
    Public vartablafacturas As String = "CREATE TABLE IF NOT EXISTS `facturas` (
                                          ...
                                          `descuento` float NOT NULL DEFAULT '0',
                                          `iva` float NOT NULL DEFAULT '0',
                                          `preciopaq` float NOT NULL DEFAULT '0',
                                          `id_emisor` float NOT NULL DEFAULT '0',
                                          ...
                                          `nom_isr` float NOT NULL DEFAULT '0',
...
"
    ...
    'Productos
    Public vartablaproductos As String = "CREATE TABLE IF NOT EXISTS `productos` (
                                              `Id` int(11) NOT NULL,
                                              `Codigo` varchar(50) NOT NULL DEFAULT '',
                                              ...
                                              `Descu` varchar(50) NOT NULL DEFAULT '',
                                              `Status_Promocion` int(1) NOT NULL DEFAULT '0',
                                              `Porcentaje_Promo` float NOT NULL DEFAULT '0',
                                              `Fecha_Inicial` varchar(255) NOT NULL DEFAULT '',
                                              `Fecha_Final` varchar(255) NOT NULL DEFAULT '',
                                              ...
                                              `Cant_Ent` float NOT NULL DEFAULT '0',
                                              `E1` int(1) NOT NULL DEFAULT '0',
                                              `E2` int(1) NOT NULL DEFAULT '0',
                                              `Modo_Almacen` int(1) NOT NULL DEFAULT '0',

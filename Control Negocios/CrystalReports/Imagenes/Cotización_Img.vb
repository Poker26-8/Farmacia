...
Public Class Cotización_Img
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Control_Negocios.Cotización_Img.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCotización_Img
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Cotización_Img = New Cotización_Img()
        rpt.Site = Me.Site
        Return rpt
    End Function

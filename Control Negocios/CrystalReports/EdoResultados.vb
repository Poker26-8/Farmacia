...
Public Class EdoResultados
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Control_Negocios.EdoResultados.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEdoResultados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EdoResultados = New EdoResultados()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class VentaDescuento
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Control_Negocios.VentaDescuento.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Pagare() As CrystalDecisions.CrystalReports.Engine.Section
        Get
...
Public Class CachedVentaDescuento
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VentaDescuento = New VentaDescuento()
        rpt.Site = Me.Site
        Return rpt
    End Function

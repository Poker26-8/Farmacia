...
Public Class CotizacionDescuento
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CotizacionDescuento.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Control_Negocios.CotizacionDescuento.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCotizacionDescuento
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CotizacionDescuento = New CotizacionDescuento()
        rpt.Site = Me.Site
        Return rpt
    End Function

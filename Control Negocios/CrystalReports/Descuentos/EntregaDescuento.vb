...
Public Class EntregaDescuento
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Control_Negocios.EntregaDescuento.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEntregaDescuento
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EntregaDescuento = New EntregaDescuento()
        rpt.Site = Me.Site
        Return rpt
    End Function

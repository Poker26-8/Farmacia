...
Public Class VentaEscuela
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Control_Negocios.VentaEscuela.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVentaEscuela
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VentaEscuela = New VentaEscuela()
        rpt.Site = Me.Site
        Return rpt
    End Function
